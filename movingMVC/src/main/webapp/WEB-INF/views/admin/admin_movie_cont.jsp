...
<div id="aMovie_uploadWrap">
	...
	<div id="aMovie_upload" class="tab-content on">
			...
			<div id="aMUploadCenter">
				<table border="1" id="aMUpload_table" >
					...
					<tr>
						<th>감독</th>
						<td>
						<input name="director" id="aMUploadC_director" value="${vp.director }" disabled/>
						&nbsp;&nbsp;&nbsp;출연진&nbsp;
						<input name="actor" id="aMUploadC_actor" size="30" value="${vp.actor }" disabled/>
						&nbsp;&nbsp;&nbsp;시대배경&nbsp;
						<input name="eraBackground" id="aMUploadC_background" size="18" value="${vp.eraBackground }" disabled/>
						</td>
					</tr>
					<tr>
						...
						<td class="tdName">
							<div id="aMUploadC_combo" class="select" >
								<select id="aMUploadC_genre" name="codeNo" class="combo" disabled>
									<option value="30001"
								...
								&nbsp;&nbsp;&nbsp;상영등급&nbsp;
								<select id="aMUploadC_rating" name="rate" class="combo" disabled>
									<option value="null"
								...
								<input type="number" name="videoLength" class="time" id="aMUploadC_runningTime"
									value="${vp.videoLength }" disabled/>분
							</div>
						...
						<td>
							...
							<div id="aMUploadC_title">
								...
								<input type="text" name="titleKorean" class="korean title"
									id="aMUploadC_titleText" value="${vp.titleKorean }" disabled/>
								<input type="text" name="titleEnglish" class="english title"
									id="aMUploadC_titleText2" value="${vp.titleEnglish }" disabled/>
								<input type="date" name="releaseDate" class="year"
									id="aMUploadC_titleText3" value="${fn:substring(vp.releaseDate,0,10)}" disabled/>
							</div>
						</td>
					</tr>
					<tr>
						...
						<td>
							...
							<div id="aMUploadC_cont">
								<textarea name="content" id="aMUploadC_contText" class="txtbox content"
									placeholder="내용을 입력하세요." rows="22" cols="85"  disabled>${vp.content }</textarea>
							</div>
						</td>
					</tr>
					<tr>
						...
						<td><input name="videoFilePath" id="aMUploadR_url" size="50" value="${vp.videoFilePath }" disabled/></td>
					</tr>
				</table>
			...
			<div id="aMUploadR_uploadBtn">
				<button type="button" class="button editBtn">수정</button>
			</div>
	</div>
			...
			<div id="aMUploadCenter">
				<table border="1" id="aMUpload_table">
					...
					<tr>
						<th>감독</th>
						<td>
							<input name="director" id="aMUploadC_directorT" value="${vp.director }" disabled/>
						</td>
					</tr>
					<tr>
						<th>장르</th>
						<td>
							<div id="aMUploadC_combo">
								...
								&nbsp;&nbsp;&nbsp;상영등급&nbsp;
								<select id="aMUploadC_ratingT" name="rate" class="combo" disabled>
									<option value="null"
									<c:if test="${rate==null }"> ${'selected' }</c:if>>선택하세요.</option>
									<option value="g"
									<c:if test="${rate==g }"> ${'selected' }</c:if>>전체 관람가</option>
					...
					<tr>
						...
						<td>
							...
							<div id="aMUploadC_title">
								...
								<input type="text" name="titleKorean" class="korean title"
									id="aMUploadC_titleTextT" value="${vp.titleKorean }" disabled/>
								<input type="text" name="titleEnglish" class="english title"
									id="aMUploadC_titleTextT2" value="${vp.titleEnglish }" disabled/>
								<input type="date" name="releaseDate" class="year"
									id="aMUploadC_titleTextT3" value="${fn:substring(vp.releaseDate,0,10)}" disabled/>
							</div>
						</td>
					</tr>
					<tr>
...
<script>
	$(function(){
		...
		$('.editBtn').click(function(){
			location.href="/moving.com/admin/movie/movie_edit?id=${vp.id}&page=${page}&findField=${findField}&findName=${findName}";
		})
	});
</script>
