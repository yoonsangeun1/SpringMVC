 ...
 onsubmit="return actors_check();" enctype="multipart/form-data">
  <table border="1" style="width:1024px" cellspacing="0" > <!-- width 임시로 넣어둠. -->
   ...
   <tr>
    <th>카테고리</th>
    <td>
    <input type="checkbox" name="category" id="category1" value="actor" />배우
    <input type="checkbox" name="category" id="category2" value="stunt" />스턴트맨
    <input type="checkbox" name="category" id="category3" value="childactor" />아역배우
    <input type="checkbox" name="category" id="category4" value="etc" onclick="checketc(this);"/>기타
...
<script>
 ...
 function checketc(ck){			//기타 클릭 시 텍스트 필드 활성화, 비활성화
	if(ck.checked == true){
