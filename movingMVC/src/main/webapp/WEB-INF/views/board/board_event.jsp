...
<div id="bEvent_update"> <%--왼쪽 업데이트 사항. 공지,이벤트 등 div --%>
 ...
 <div id="bEvent_header"> <%--이벤트 h3 넣는 div --%>
  ...
  <div class="events" <%--onmouseover="bEvent_events_over(this);" --%>> <%--나중에 js적용해야함 --%>
   <a href="#" target="_blank"> <%--이벤트 클릭 시 이동, 임시로 네이버 지정함 --%>
    <span class="bEvent_image"> <%--이미지 span태그 --%>
     <img src="resources/images/bEvent01.png" />
    </span> <%--이미지 span태그 --%>
  ...
  <div class="events">
   <a href="#" target="_blank"> <%--이벤트 클릭 시 이동, 임시로 네이버 지정함 --%>
    <span class="bEvent_image"> <%--이미지 span태그 --%>
     <img src="resources/images/bEvent02.png" />
    </span> <%--이미지 span태그 --%>
  ...
  <div class="events">
   <a href="#" target="_blank"> <%--이벤트 클릭 시 이동, 임시로 네이버 지정함 --%>
    <span class="bEvent_image"> <%--이미지 span태그 --%>
     <img src="resources/images/bEvent03.png" />
    </span> <%--이미지 span태그 --%>
  ...
  <div class="events">
   <a href="#" target="_blank"> <%--이벤트 클릭 시 이동, 임시로 네이버 지정함 --%>
    <span class="bEvent_image"> <%--이미지 span태그 --%>
     <img src="resources/images/bEvent04.png" />
    </span> <%--이미지 span태그 --%>
  ...
  <div class="events">
   <a href="#" target="_blank"> <%--이벤트 클릭 시 이동, 임시로 네이버 지정함 --%>
    <span class="bEvent_image"> <%--이미지 span태그 --%>
     <img src="resources/images/bEvent05.png" />
    </span> <%--이미지 span태그 --%>
  ...
  <div class="events">
   <a href="#" target="_blank"> <%--이벤트 클릭 시 이동, 임시로 네이버 지정함 --%>
    <span class="bEvent_image"> <%--이미지 span태그 --%>
     <img src="resources/images/bEvent06.png" />
    </span> <%--이미지 span태그 --%>
  ...
  <div class="events">
   <a href="#" target="_blank"> <%--이벤트 클릭 시 이동, 임시로 네이버 지정함 --%>
    <span class="bEvent_image"> <%--이미지 span태그 --%>
     <img src="resources/images/bEvent07.png" />
    </span> <%--이미지 span태그 --%>
  ...
  <div class="events">
   <a href="#" target="_blank"> <%--이벤트 클릭 시 이동, 임시로 네이버 지정함 --%>
    <span class="bEvent_image"> <%--이미지 span태그 --%>
     <img src="resources/images/bEvent08.png" />
    </span> <%--이미지 span태그 --%>
  ...
  <div class="events">
   <a href="#" target="_blank"> <%--이벤트 클릭 시 이동, 임시로 네이버 지정함 --%>
    <span class="bEvent_image"> <%--이미지 span태그 --%>
     <img src="resources/images/bEvent09.png" />
    </span> <%--이미지 span태그 --%>
  ...
  <div class="events">
   <a href="#" target="_blank"> <%--이벤트 클릭 시 이동, 임시로 네이버 지정함 --%>
    <span class="bEvent_image"> <%--이미지 span태그 --%>
     <img src="resources/images/bEvent10.png" />
    </span> <%--이미지 span태그 --%>
