...
<body>
 ...
 <input type="hidden" name="page" value="${page}" />
  ...
  <div id="bQna_community">
		...
		<div class="bQna_community_list">
			...
			<ul>
				...
				<li  class="bQna_community_list_free"><a href="qna">QnA</a> <%--QnA 작업해야 됨 --%></li>
  ...
  <table border="1" id="bQna_edit_table" cellspacing="0">

   <tr>
    <th id="bQna_edit_nickname">닉네임 : </th>
    <th id="bQna_edit_nickname_2">${bq.mUserVO.nickname}</th>      
   </tr> 
   
   <tr>
    <th id="bQna_edit_title">&nbsp;&nbsp;&nbsp;제목 : </th>
 <td id="bQna_edit_title_2">
 ...
 value="${bq.title}" />
   ...
   <tr>
    <td colspan="2" id="bQna_edit_content"><textarea name="content" id="content" 
    rows="10" cols="100">${bq.content}</textarea>
  ...
  <div id="bQna_edit_button"> <%-- 버튼 div --%>
  
    <input type="submit" value="수정" class="bQna_edit_btn button
       button_c9d8ce2 button_f12 button_p1024 button_r4" />
    <input type="reset" value="취소" class="bQna_edit_btn button
       button_c9d8ce2 button_f12 button_p1024 button_r4" />
    <input type="button" value="목록" class="bQna_edit_btn button
       button_c9d8ce2 button_f12 button_p1024 button_r4"
