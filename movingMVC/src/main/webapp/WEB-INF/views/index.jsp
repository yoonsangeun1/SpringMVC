...
<link rel="stylesheet" type="text/css"
	href="./resources/iconfont/css/fontawesome.min.css">
<script src="https://kit.fontawesome.com/bf95efc607.js"
	crossorigin="anonymous"></script>
<link rel="stylesheet" href="./resources/icon/css/fontello.css">
<link rel="stylesheet" href="./resources/icon/css/animation.css">
...
<%-- 공지사항 --%>
<link rel="stylesheet" type="text/css" href="./resources/css/board_event.css" />
<%-- 이벤트 --%>
<link rel="stylesheet" type="text/css" href="./resources/css/board_faq.css" />
<%-- FAQ --%>
<link rel="stylesheet" type="text/css" href="./resources/css/board_actors.css" />
<%-- 배우 모집 --%>
<link rel="stylesheet" type="text/css" href="./resources/css/board_contest.css" />
<%-- 시나리오 모집 --%>
<link rel="stylesheet" type="text/css" href="./resources/css/board_free.css" />
<%-- 자유게시판 --%>
<link rel="stylesheet" type="text/css" href="./resources/css/board_writing.css" />
<%-- 글 작성 폼 --%>
<link rel="stylesheet" type="text/css" href="./resources/css/board_qna.css" />
<%-- Q & A--%>

<%-- funding css 추가 --%>
<link rel="stylesheet" type="text/css" href="./resources/css/funding_list.css" />
<%-- 펀딩 리스트 --%>
<link rel="stylesheet" type="text/css" href="./resources/css/funding_write.css" />
<%-- 펀딩 글 작성 폼 --%>
<link rel="stylesheet" type="text/css" href="./resources/css/funding_cont.css" />
<%-- 펀딩 글 보기 --%>
...
<%-- movie css 추가 --%>
<link rel="stylesheet" type="text/css" href="./resources/css/movie_cont.css" />
<link rel="stylesheet" type="text/css" href="./resources/css/movie_mainList.css" />
<link rel="stylesheet" type="text/css"
	href="./resources/css/movie_categoryList.css" />

<%-- sns css 추가 --%>
<link rel="stylesheet" type="text/css" href="./resources/css/sns_main.css" />
<link rel="stylesheet" type="text/css" href="./resources/css/sns_profile.css" />
<link rel="stylesheet" type="text/css" href="./resources/css/sns_messenger.css" />

<%-- javascript 추가 (우선, abc순)--%>
<script src="./resources/js/board_event.js"></script>
<script src="./resources/js/board_faq.js"></script>
<script src="./resources/js/funding_write.js"></script>
<script src="./resources/js/jquery.js"></script>
<script src="./resources/js/move_banner.js"></script>
<script src="./resources/js/movie_cont.js"></script>
