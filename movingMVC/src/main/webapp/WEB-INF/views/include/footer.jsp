<%@ page contentType="text/html; charset=UTF-8" %>
			...
			<div id="global_footer_wrap">
				...
				<div id="footer_moving">
					<a href="#"><img src="${pageContext.request.contextPath}/images/test.png" alt="test" width="20"
				...
				<div id="footer_sns">
					<a href="#"><img src="${pageContext.request.contextPath}/images/test.png" alt="test" width="20"
						...
						src="${pageContext.request.contextPath}/images/test.png" alt="test" width="20" height="20"
