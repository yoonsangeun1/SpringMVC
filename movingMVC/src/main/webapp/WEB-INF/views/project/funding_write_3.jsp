...
<body>
<body
	class="empty projects maison-book not-mobile not-phone not-mobile-safari not-chrome-ios not-forces-video-controls not-tablet not-ipad not-iphone not-ios not-android not-touchable not-native-app-request not-apple-pay-capable not-android-pay-capable responsive is-logged-in  skip_autologin"
	id="projects_start">
	<div id="app">
		<div class="grid-container">
			<div>
				<div class="grid-row">
					<div class="grid-col-12 py3 flex items-center justify-center">
						<div class="w5 pr7 hide display-inline-sm"></div>
						<a href="/?ref=build-onboarding-page-1"
							class="mb0 ml-auto mr-auto w30"><svg class="valign-middle"
								xmlns="http://www.w3.org/2000/svg" viewBox="0 0 598 70"
								width="100%" height="100%">
								<title>Kickstarter</title><g class="fill-ksr-green-800"
									fill-rule="nonzero">
								<path
								...
								<path
									d="M143,43.5099338 C143,37.1523179 139.818713,32.6821192 133.45614,30 C139.818713,27.3178808 143,22.9470199 143,16.4900662 C143,6.85430464 134.947368,0 122.023392,0 C104.725146,0 92,12.8145695 92,30 C92,47.1854305 104.725146,60 122.023392,60 C134.947368,60 143,53.1456954 143,43.5099338"></path>
								<path
									d="M72.5499366,0 C64.4666385,0 58,6.57807309 58,14.3521595 L58,45.6478405 C58,53.5215947 64.4666385,60 72.4488953,60 C80.6332346,60 86.9988319,53.4219269 86.9988319,45.6478405 L86.9988319,14.3521595 C87.0998731,6.57807309 80.6332346,0 72.5499366,0"></path>
								<path
						...
						<div tabindex="0" class="inline-block">
							<button class="relative z10">
								<img
									class="avatar inline-block align-middle circle w5 h5 border border-grey-500 shadow-avatar"
									src="https://ksr-ugc.imgix.net/missing_user_avatar.png?ixlib=rb-2.1.0&amp;w=160&amp;h=160&amp;fit=crop&amp;v=&amp;auto=format&amp;frame=1&amp;q=92&amp;s=dcbf8315c895755eb38c778c1414f508"
									alt="user avatar"
									style="text-indent: 100%; white-space: nowrap; overflow: hidden;">
							</button>
							<ul
								class="shadow-avatar z10 absolute r0-sm r2 p1 l2 l-auto-sm mt1 mt0-sm w30-sm bg-white transition-all transition-500 t6 o0p"
								style="pointer-events: none;">
								<li><a href="/profile?ref=build-onboarding-page-1"
									target="_self"
									class="navy-600 hover-navy-700 type-14-sm type-16 block w100p hover-bg-grey-400 py1 px2">Profile</a></li>
								<li><a href="/profile/projects?ref=build-onboarding-page-1"
									target="_self"
									class="navy-600 hover-navy-700 type-14-sm type-16 block w100p hover-bg-grey-400 py1 px2">My
										projects</a></li>
								<li><a href="/settings/account?ref=build-onboarding-page-1"
									target="_self"
									class="navy-600 hover-navy-700 type-14-sm type-16 block w100p hover-bg-grey-400 py1 px2">Account</a></li>
								<li><a href="/logout?ref=build-onboarding-page-1"
									target="_self"
									class="navy-600 hover-navy-700 type-14-sm type-16 block w100p hover-bg-grey-400 py1 px2">Logout</a></li>
							</ul>
							<div class="fixed t0 r0 l0 b0 bg-white_95 z1 hide"></div>
						</div>
					</div>
					<div class="grid-col-12">
						<div class="mx-4 mx0-sm">
							<div class="h2px bg-grey-300 w100p mb1">
								<div class="transition-all transition-900 h2px bg-black w0"></div>
							</div>
						</div>
						<div class="medium hide display-inline-sm">1 of 3</div>
					</div>
				</div>
			</div>
			<div class="grid-row pt7vh pt15vh-sm">
				<div class="grid-col-12 grid-col-7-sm grid-col-6-lg grid-col-center">
					<div class="pb14-sm pb5" data-id="onboarding-category-tab">
						<h2 class="type-28-sm type-21 black lh4 lh6-sm normal center mb2">First, let’s get you set up.</h2>
						<h3
							class="type-18-sm type-14 lh3 lh4-sm black_60 normal center mb6">Pick a project category to connect with a specific community. You can always update this later.</h3>
						<div class="navy-700">
							<div role="listbox" aria-labelledby="custom-select-heading-label"
								class="relative w100p pointer input-keyboard-focusable-soft-black">
								<div
									class="shadow-hover border border-transparent hover-border-soft-black transition-all rounded py2 px3 bg-white flex items-center shadow-2 h9 input-keyboard-focusable-soft-black"
									aria-hidden="true" aria-label="Select an option" tabindex="0">
									<span
										class="type-16 type-18-md grow-1 text-truncate pr1 book dark-grey-500">Select your category</span>
									<svg class="svg-icon__delta-down icon-10 flex-noshrink"
										aria-hidden="true">
										<use xlink:href="#delta-down"></use></svg>
								</div>
								<ul
									class="absolute w100p shadow-3 border shadow-card scroll-y max-h50 p1 bg-white mt1 mb10 rounded z-dropdown-3 border-box subhead-300 mb1 border-soft-black visually-hide"
									role="presentation">
									<li role="option" tabindex="-1" aria-selected="false"
										class="px2 flex items-center transition-all lh3 soft-black py2"><span
										class="type-16 type-18-md mr2">Art</span></li>
									<li role="option" tabindex="-1" aria-selected="false"
										class="px2 flex items-center transition-all lh3 soft-black py2"><span
										class="type-16 type-18-md mr2">Comics</span></li>
									<li role="option" tabindex="-1" aria-selected="false"
										class="px2 flex items-center transition-all lh3 soft-black py2"><span
										class="type-16 type-18-md mr2">Crafts</span></li>
									<li role="option" tabindex="-1" aria-selected="false"
										class="px2 flex items-center transition-all lh3 soft-black py2"><span
										class="type-16 type-18-md mr2">Dance</span></li>
									<li role="option" tabindex="-1" aria-selected="false"
										class="px2 flex items-center transition-all lh3 soft-black py2"><span
										class="type-16 type-18-md mr2">Design</span></li>
									<li role="option" tabindex="-1" aria-selected="false"
										class="px2 flex items-center transition-all lh3 soft-black py2"><span
										class="type-16 type-18-md mr2">Fashion</span></li>
									<li role="option" tabindex="-1" aria-selected="false"
										class="px2 flex items-center transition-all lh3 soft-black py2"><span
										class="type-16 type-18-md mr2">Film &amp; Video</span></li>
									<li role="option" tabindex="-1" aria-selected="false"
										class="px2 flex items-center transition-all lh3 soft-black py2"><span
										class="type-16 type-18-md mr2">Food</span></li>
									<li role="option" tabindex="-1" aria-selected="false"
										class="px2 flex items-center transition-all lh3 soft-black py2"><span
										class="type-16 type-18-md mr2">Games</span></li>
									<li role="option" tabindex="-1" aria-selected="false"
										class="px2 flex items-center transition-all lh3 soft-black py2"><span
										class="type-16 type-18-md mr2">Journalism</span></li>
									<li role="option" tabindex="-1" aria-selected="false"
										class="px2 flex items-center transition-all lh3 soft-black py2"><span
										class="type-16 type-18-md mr2">Music</span></li>
									<li role="option" tabindex="-1" aria-selected="false"
										class="px2 flex items-center transition-all lh3 soft-black py2"><span
										class="type-16 type-18-md mr2">Photography</span></li>
									<li role="option" tabindex="-1" aria-selected="false"
										class="px2 flex items-center transition-all lh3 soft-black py2"><span
										class="type-16 type-18-md mr2">Publishing</span></li>
									<li role="option" tabindex="-1" aria-selected="false"
										class="px2 flex items-center transition-all lh3 soft-black py2"><span
										class="type-16 type-18-md mr2">Technology</span></li>
									<li role="option" tabindex="-1" aria-selected="false"
										class="px2 flex items-center transition-all lh3 soft-black py2"><span
										class="type-16 type-18-md mr2">Theater</span></li>
								</ul>
							</div>
						</div>
					</div>
			...
			<div class="grid-row">
				<div class="grid-col-12 grid-col-7-sm grid-col-6-lg grid-col-center">
					<div
						class="flex flex-column flex-row-reverse-sm flex-row-sm items-center-sm border-top-sm border-grey-400 py3"
						data-id="paginated-nav">
						<button disabled="" type="button"
							class="bttn bttn-medium bttn-default keyboard-focusable-black shadow-button">Next: Project idea</button>
						<span
							class="type-13 type-14-md dark-grey-500 mr-auto-sm type-14 text-center text-left-sm pt3 pt0-sm">Your first project! Welcome.</span>
					</div>
				</div>
			</div>
			<div class="grid-row">
				<div class="grid-col-12 grid-col-7-sm grid-col-6-lg grid-col-center">
					<span class="type-12 dark-grey-400 block mt10 text-center">To create a project, you're required to provide your location, age, national ID, banking and tax information, email, and mailing address. This information is necessary to prevent fraud, comply with the law, and — if your project is successful — to deliver funds.
...
<script>
	if (window.benchmark) {
		window.performance.mark("begin_base.js_tag");
	}
</script>
<script
		src="https://a.kickstarter.com/assets/modules/runtime.7f3b34ef46a6d7f993417837cf8bd5f0599a17ce5cc7d9673a069b50102f9f61.js"></script>
<script
		src="https://a.kickstarter.com/assets/modules/vendor.5c79ce4b497702d8a1ffdfdc66596a4d3f3e29005bd910b80f7b9455a6b853e0.js"></script>
<script
		src="https://a.kickstarter.com/assets/modules/core.00fc5e13463be206a2066e49ba5bae382b1a82796410f794658b72f6310fd485.js"></script>
<script
		src="https://a.kickstarter.com/assets/modules/project-build.9195186120b4278e7b0c955ba6e4e5a4f7d32daf3770b5a1339298a1e99ccac3.js"></script>
<script>
	if (window.benchmark) {
		window.performance.mark("end_base.js_tag");
	}
</script>
		...
		<div
			...
			<div>
				<iframe name="fb_xdm_frame_https" id="fb_xdm_frame_https"
					...
					src="https://staticxx.facebook.com/connect/xd_arbiter.php?version=44#channel=f2e2adc3130414c&amp;origin=https%3A%2F%2Fwww.kickstarter.com"
...
<script>
	var channelUrl = window.location.protocol + "//" + window.location.host
			+ "/channel.html", needs_autologin = true && !$('body').is(
			'.skip_autologin'), needs_refresh = true && false;
		...
		FB.getLoginStatus(function(response) {
			if (response.status === 'connected') {
				if (read_cookie("logout_from_fb")) {
					...
					$.get("/fb/autologin.js", {
						'fbsr' : response.authResponse.signedRequest
					});
...
<svg xmlns="http://www.w3.org/2000/svg" style="display: none;">
    ...
    <symbol id="arrow-down" viewBox="0 0 729 437">
      ...
      <title>arrow-down</title>
		<path
			d="M364.42 437.406L728.405 73.42 655.608.62l-291.19 290.682L73.204.594.406 73.392"
			fill-rule="evenodd"></path>
    </symbol>
    <symbol id="arrow-left" viewBox="0 0 437 728">
      ...
      <title>arrow-left</title>
		<path
			d="M0 364.014L363.986 728l72.797-72.797L146.1 364.013 436.81 72.798 364.015 0"
			fill-rule="evenodd"></path>
    </symbol>
    <symbol id="arrow-point-left" viewBox="0 0 15 8">
      ...
      <title>Fill 1 Copy 5</title>
		<path
			d="M3.93 7.936c.136.136.368.04.368-.152V5h10.436c.097 0 .175-.08.175-.175v-1.65c0-.097-.08-.175-.176-.175H4.298V.215c0-.19-.232-.287-.368-.152L.063 3.847c-.084.085-.084.22 0 .305L3.93 7.936z"
			fill-rule="evenodd"></path>
    </symbol>
    <symbol id="arrow-point-right" viewBox="0 0 15 8">
      ...
      <title>Fill 1</title>
		<path
			d="M10.98.064c-.137-.136-.37-.04-.37.152V3H.176C.078 3 0 3.08 0 3.175v1.65C0 4.922.078 5 .175 5H10.61v2.785c0 .19.233.287.37.152l3.866-3.784c.084-.085.084-.22 0-.305L10.98.064z"
			fill-rule="evenodd"></path>
    </symbol>
    ...
    <symbol id="bell" viewBox="0 0 14 16">
      ...
      <title>Combined Shape Copy 5</title>
		<path
			d="M6.686 16c1.058 0 1.92-.796 2.047-1.82H4.638c.127 1.024.99 1.82 2.048 1.82zm6.045-4.53c-.907-1.205-1.097-2.435-1.327-4.145L11.1 5.06C10.813 2.91 9.325 1.25 7.47.88c.002-.028.015-.052.015-.08 0-.44-.357-.8-.798-.8-.442 0-.8.36-.8.8 0 .028.013.052.016.08-1.858.37-3.343 2.028-3.632 4.18L1.746 9c-.185.88-.46 1.65-1.002 2.395C.287 11.907 0 12.573 0 13.312c0 .037.032.068.068.068h13.236c.037 0 .067-.03.067-.068v-.073c0-.676-.245-1.285-.64-1.77z"
			fill-rule="evenodd"></path>
    </symbol>
    <symbol id="book" viewBox="0 0 655 715">
      ...
      <title>Artboard Copy 3</title>
		<path
			d="M654.804 119.53L595.47 60.195v595.47H118.666c-30.023 0-59.332-15.01-59.332-59.33H536.14V.147H89.355C0 .148 0 .148 0 89.505V595.62C0 684.976 74.345 715 148.69 715h506.114V119.53z"
			fill-rule="evenodd"></path>
    </symbol>
    <symbol id="bookmark" viewBox="0 0 12 16">
      ...
      <title>Fill 1</title>
		<path
			d="M.704 0h10.592c.39 0 .704.315.704.704v14.464c0 .34-.39.533-.66.327l-5.148-3.94-5.54 3.978c-.273.195-.652 0-.652-.334V.703C0 .314.315 0 .704 0"
			fill-rule="evenodd"></path>
    </symbol>
    ...
    <symbol id="chat" viewBox="0 0 750 750">
      ...
      <title>chat</title>
		<path
			d="M375.2 723.3c52 0 101.5-10.3 146.3-28.6 1.1-.5 2-.9 3.1-1.3.2 0 .4 0 .4-.2 6.3-2.3 13.1-3.6 20.2-3.6 7.7 0 15.1 1.4 21.8 4.3l151.2 55.6-39.8-159.1c0-9.5 2.7-18.5 7-26.3 1.4-2.3 2.9-4.7 4.5-6.7 37.6-56.3 59.4-123.3 59.4-195.1C749.7 162.5 582.1.7 375.3.7S.8 162.6.8 362c0 199.7 167.6 361.3 374.4 361.3z"
			fill-rule="evenodd"></path>
    </symbol>
    <symbol id="check" viewBox="0 0 20 16">
      ...
      <title>Fill 1 Copy 6</title>
		<path
			d="M6.8 15.88L.12 9.173c-.16-.16-.16-.42 0-.58L1.46 7.26c.16-.16.418-.16.58 0l4.95 4.973L17.695.14c.15-.17.41-.187.58-.037l1.414 1.25c.17.15.186.41.035.58L7.4 15.863c-.16.176-.432.184-.6.016"
			fill-rule="evenodd"></path>
    </symbol>
    ...
    <symbol id="circle-forward" viewBox="0 0 17 16">
      ...
      <title>Fill 1 Copy 16</title>
		<path
			d="M8 0c2.197 0 4.278.91 5.786 2.49l.01-.01L15.687.6c.13-.13.353-.037.353.147l.042 5.18c0 .114-.094.204-.206.204l-5.18-.068c-.183 0-.276-.222-.146-.353l.73-.728 1.16-1.153.058-.06c-1.17-1.24-2.784-1.966-4.5-1.966-3.415 0-6.196 2.78-6.196 6.195 0 3.417 2.78 6.196 6.197 6.196 2.563 0 4.833-1.58 5.76-3.947 0 0 .07-.273.36-.184l1.177.397c.17.062.238.115.2.29C14.346 13.896 11.366 16 8 16c-4.413 0-8-3.59-8-8s3.587-8 8-8"
			fill-rule="evenodd"></path>
    </symbol>
    ...
    <symbol id="compass" viewBox="0 0 16 16">
      ...
      <title>Combined Shape Copy 2</title>
		<path
			d="M8.543 8.6l-2.035.917.938-2.088 1.11 1.14-.013.03zm3.632-5.01l-.095.043-5.784 2.61-2.624 5.848c-.085.188.02.37.247.273v.004l5.783-2.61 2.66-5.928v-.003l.015-.028c.08-.178-.04-.283-.203-.21zM8 14.467c-3.565 0-6.467-2.902-6.467-6.467 0-3.565 2.902-6.467 6.467-6.467 3.565 0 6.467 2.902 6.467 6.467 0 3.565-2.902 6.467-6.467 6.467M8 0C3.583 0 0 3.583 0 8c0 4.42 3.583 8 8 8s8-3.58 8-8c0-4.417-3.583-8-8-8"
			fill-rule="evenodd"></path>
    </symbol>
    ...
    <symbol id="delta-down" viewBox="0 0 12 6">
      ...
      <title>Fill 1</title>
		<path
			d="M.307 0h10.775c.273 0 .41.33.216.523L5.91 5.91c-.12.12-.312.12-.432 0L.09.523C-.103.33.034 0 .307 0"
			fill-rule="evenodd"></path>
    </symbol>
    <symbol id="delta-left" viewBox="0 0 7 12">
      <title>delta-left icon</title>
      <path
			d="M6.694.613v10.774c0 .273-.33.41-.523.217L.785 6.217c-.12-.12-.12-.314 0-.434L6.17.396c.194-.193.524-.056.524.217"
			fill-rule="evenodd"></path>
    </symbol>
    <symbol id="delta-right" viewBox="0 0 7 12">
      ...
      <title>Fill 1</title>
		<path
			d="M.694.613v10.774c0 .273.33.41.524.217l5.387-5.387c.12-.12.12-.314 0-.434L1.218.396C1.024.203.694.34.694.613"
			fill-rule="evenodd"></path>
    </symbol>
    <symbol id="delta-up" viewBox="0 0 12 6">
      ...
      <title>Fill 1</title>
		<path
			d="M.307 6h10.775c.273 0 .41-.33.216-.523L5.91.09c-.12-.12-.312-.12-.432 0L.09 5.477C-.103 5.67.034 6 .307 6"
			fill-rule="evenodd"></path>
    </symbol>
    <symbol id="duplicate" viewBox="0 0 591 751">
      ...
      <title>duplicate</title>
		<path
			d="M65.59 688.417V93.875H0V751h491.935v-62.583H65.59zM437.208 0H98.387v657.125h491.935V146.68L437.207 0zm87.524 219.042H360.753V62.582h32.796V187.75H524.73v31.292z"
			fill-rule="evenodd"></path>
    </symbol>
    ...
    <symbol id="flag" viewBox="0 0 15 16">
      ...
      <title>Fill 1 Copy 3</title>
		<path
			d="M12.63.662c-.097-.286-.41-.438-.695-.34l-2.628.908L9.01.37C8.913.083 8.6-.07 8.316.03l-5.77 1.99c-.044.015-.078.043-.114.066L1.904.556c-.055-.16-.23-.244-.39-.19L.207.82c-.16.054-.244.228-.19.388l5.03 14.585c.056.16.23.246.39.19l1.308-.45c.16-.056.245-.23.19-.39L4.55 8.225c.042-.004.085-.002.128-.017l3.245-1.12.297.86c.098.286.41.437.696.34l5.154-1.78c.285-.097.437-.408.34-.694L12.63.662z"
			fill-rule="evenodd"></path>
    </symbol>
    ...
    <symbol id="human" viewBox="0 0 44 52">
      ...
      <title>icon--human</title>
		<path
			d="M36 14c0 7.732-6.268 14-14 14S8 21.732 8 14 14.268 0 22 0s14 6.268 14 14zM1 52c-.552 0-1-.448-1-1v-7.872c0-.28.114-.552.318-.746C5.78 37.23 13.46 34 22 34c8.538 0 16.218 3.228 21.682 8.382.204.194.318.466.318.746V51c0 .552-.448 1-1 1H1z"
			fill-rule="evenodd"></path>
    </symbol>
    ...
    <symbol id="icon--alert" viewBox="0 0 60 60">
      ...
      <title>icon--alert</title>
		<g fill-rule="evenodd">
		<path
			d="M30 4c14.36 0 26 11.64 26 26S44.36 56 30 56 4 44.36 4 30 15.64 4 30 4zm0 46.5c11.304 0 20.5-9.196 20.5-20.5S41.304 9.5 30 9.5 9.5 18.696 9.5 30 18.696 50.5 30 50.5zm0-13c1.93 0 3.5 1.57 3.5 3.5s-1.57 3.5-3.5 3.5-3.5-1.57-3.5-3.5 1.57-3.5 3.5-3.5zM28.23 34c-.277 0-.5-.202-.5-.45l-.48-4.95V16.45c0-.248.223-.45.5-.45h4.5c.275 0 .5.202.5.45V28.6l-.49 4.95c0 .248-.223.45-.5.45h-3.53z"></path></g>
    </symbol>
    <symbol id="icon--arrow-down" viewBox="0 0 60 60">
      ...
      <title>icon--arrow-down</title>
		<g fill-rule="evenodd">
		<path
			d="M40.707 42H33V5c0-.552-.447-1-1-1h-4c-.553 0-1 .448-1 1v37h-7.707c-.874 0-1.326 1.042-.732 1.68l10.707 11.53c.396.426 1.07.426 1.466 0L41.44 43.68c.593-.638.14-1.68-.733-1.68"></path></g>
    </symbol>
    <symbol id="icon--arrow-left" viewBox="0 0 60 60">
      ...
      <title>icon--arrow-left</title>
		<g fill-rule="evenodd">
		<path
			d="M55 27H18v-7.708c0-.872-1.042-1.326-1.68-.732L4.79 29.268c-.426.396-.426 1.068 0 1.464L16.32 41.44c.638.594 1.68.14 1.68-.732V33h37c.552 0 1-.448 1-1v-4c0-.552-.448-1-1-1"></path></g>
    </symbol>
    <symbol id="icon--arrow-right" viewBox="0 0 60 60">
      ...
      <title>icon--arrow-right</title>
		<g fill-rule="evenodd">
		<path
			d="M55.363 29.268L43.68 18.42c-.64-.594-1.68-.142-1.68.732V27H5c-.553 0-1 .448-1 1v4c0 .554.447 1 1 1h37v7.848c0 .874 1.04 1.328 1.68.734l11.683-10.85c.426-.394.426-1.068 0-1.464"></path></g>
    </symbol>
    <symbol id="icon--arrow-up-right" viewBox="0 0 60 60">
      ...
      <title>icon--arrow-up-right</title>
		<g fill-rule="evenodd">
		<path
			d="M53.03 6H36.97c-.863 0-1.295 1.042-.685 1.652l5.91 5.91-35.61 35.61c-.39.39-.39 1.024 0 1.414l2.828 2.828c.392.39 1.024.39 1.414 0l35.61-35.61 5.91 5.91c.61.61 1.652.178 1.652-.684V6.968c0-.534-.433-.968-.97-.968"></path></g>
    </symbol>
    ...
    <symbol id="icon--bell" viewBox="0 0 60 60">
      ...
      <title>icon--bell</title>
		<g fill-rule="evenodd">
		<path
			d="M51.14 41.56c.547 1.136.86 2.384.86 3.704v.282c0 .252-.223.454-.5.454h-43c-.275 0-.5-.202-.5-.454v-.282c0-1.32.313-2.568.86-3.704h-.01C14 33.272 14 26 14 20.546 14 13.412 19.654 7.49 27.108 6.25 27.44 4.958 28.603 4 30 4c1.397 0 2.56.958 2.893 2.25C40.347 7.49 46 13.412 46 20.546 46 26 46 33.272 51.15 41.56h-.01zM36.316 50c.724 0 1.232.756.922 1.412C35.957 54.124 33.197 56 30 56c-3.197 0-5.957-1.876-7.237-4.586-.31-.656.198-1.412.922-1.412L36.315 50z"></path></g>
    </symbol>
    <symbol id="icon--bolt" viewBox="0 0 32 48">
      <title>icon--bolt icon</title>
      <title>icon--bolt</title>
		<path
			d="M17.928 20.115L20.7 1.947C20.97.19 18.702-.735 17.684.72L.268 25.586c-.676.966.008 2.298 1.18 2.298h12.624l-2.77 18.168c-.27 1.76 1.998 2.682 3.014 1.228l17.416-24.87c.676-.963-.008-2.295-1.18-2.295H17.928z"
			fill-rule="evenodd"></path>
    </symbol>
    ...
    <symbol id="icon--bookmark" viewBox="0 0 30 30">
      ...
      <title>icon--bookmark</title>
		<path d="M6.5 3.5v21.856l8.58-5.13 8.42 5.11V3.5h-17z"></path>
    </symbol>
    <symbol id="icon--calculator" viewBox="0 0 30 30">
      <title>icon--calculator icon</title>
      <title>icon--calculator</title>
		<path
			d="M8.02 8.02h13.96v4.65H8.02zM20.82 16.15v4.65a1.17 1.17 0 1 1-2.33 0v-4.65a1.17 1.17 0 0 1 2.33 0zM16.16 20.83A1.16 1.16 0 1 1 15 19.67a1.16 1.16 0 0 1 1.16 1.16zM16.16 16.16A1.16 1.16 0 1 1 15 15a1.16 1.16 0 0 1 1.16 1.16zM11.51 20.83a1.17 1.17 0 1 1-1.16-1.16 1.16 1.16 0 0 1 1.16 1.16zM11.51 16.16A1.17 1.17 0 1 1 10.35 15a1.16 1.16 0 0 1 1.16 1.16z"></path>
		<path
			d="M11.51 20.83a1.17 1.17 0 1 1-1.16-1.16 1.16 1.16 0 0 1 1.16 1.16zM11.51 16.16A1.17 1.17 0 1 1 10.35 15a1.16 1.16 0 0 1 1.16 1.16zM16.16 20.83A1.16 1.16 0 1 1 15 19.67a1.16 1.16 0 0 1 1.16 1.16zM16.16 16.16A1.16 1.16 0 1 1 15 15a1.16 1.16 0 0 1 1.16 1.16zM20.82 16.15v4.65a1.17 1.17 0 1 1-2.33 0v-4.65a1.17 1.17 0 0 1 2.33 0zM8.02 8.02h13.96v4.65H8.02z"></path>
		<path
			d="M11.51 20.83a1.17 1.17 0 1 1-1.16-1.16 1.16 1.16 0 0 1 1.16 1.16zM11.51 16.16A1.17 1.17 0 1 1 10.35 15a1.16 1.16 0 0 1 1.16 1.16zM16.16 20.83A1.16 1.16 0 1 1 15 19.67a1.16 1.16 0 0 1 1.16 1.16zM16.16 16.16A1.16 1.16 0 1 1 15 15a1.16 1.16 0 0 1 1.16 1.16zM20.82 16.15v4.65a1.17 1.17 0 1 1-2.33 0v-4.65a1.17 1.17 0 0 1 2.33 0zM8.02 8.02h13.96v4.65H8.02z"></path>
		<path
			d="M22 4.53H8a2.33 2.33 0 0 0-2.31 2.33v16.28A2.33 2.33 0 0 0 8 25.47h14a2.33 2.33 0 0 0 2.33-2.33V6.86A2.33 2.33 0 0 0 22 4.53zm1.16 18.61A1.16 1.16 0 0 1 22 24.31H8a1.16 1.16 0 0 1-1.16-1.17V6.86A1.16 1.16 0 0 1 8 5.69h14a1.16 1.16 0 0 1 1.16 1.17z"></path>
    </symbol>
    <symbol id="icon--calendar-check" viewBox="0 0 60 60">
      <title>icon--calendar-check icon</title>
      <title>icon--calendar-check</title>
		<path
			d="M44.636 12H53v42H7V12h8.364V7c0-.552.468-1 1.045-1h4.18c.578 0 1.046.448 1.046 1v5h16.728V7c0-.552.468-1 1.045-1h4.18c.578 0 1.046.448 1.046 1v5zm-32.41 5v32h35.547V17H12.227zM27 43l-8-7c-.074-.09-.116-.728 0-1l2-2c-.076-.095.555-.137 1 0l5 5 11-14c.042-.063.67-.124 1 0l2 2c.06-.124.123.515 0 1L28 43c-.306.072-.953.126-1 0z"
			fill-rule="nonzero"></path>
    </symbol>
    <symbol id="icon--calendar" viewBox="0 0 60 60">
      ...
      <title>icon--calendar</title>
		<g fill-rule="evenodd">
		<path
			d="M14 48h32V24H14v24zm30-36V7c0-.552-.448-1-1-1h-4c-.552 0-1 .448-1 1v5H22V7c0-.552-.448-1-1-1h-4c-.552 0-1 .448-1 1v5H8v42h44V12h-8z"></path>
		<path
			d="M20 34h4v-4h-4M28 34h4v-4h-4M36 34h4v-4h-4M20 42h4v-4h-4M28 42h4v-4h-4M36 42h4v-4h-4"></path></g>
    </symbol>
    <symbol id="icon--campaign-outline" viewBox="0 0 30 30">
      <title>icon--campaign-outline icon</title>
      <title>icon--campaign-outline</title>
		<g transform="translate(1 5)" fill-rule="evenodd">
		<path d="M7 3h21V0H7M7 12h12V9H7M7 21h21v-3H7"></path>
		<circle cx="1.5" cy="19.5" r="1.5"></circle>
		<circle cx="1.5" cy="10.5" r="1.5"></circle>
		<circle cx="1.5" cy="1.5" r="1.5"></circle></g>
    </symbol>
    <symbol id="icon--check" viewBox="0 0 60 60">
      ...
      <title>icon--check</title>
		<g fill-rule="evenodd">
		<path
			d="M23.14 49.114l-16.798-14.7c-.416-.362-.458-.996-.094-1.41l2.634-3.012c.364-.414.996-.456 1.412-.092l12.92 11.306 25.4-30.842c.352-.426.982-.486 1.406-.136l3.088 2.542c.426.35.488.98.136 1.406L24.57 48.996c-.358.436-1.006.49-1.43.118z"></path></g>
    </symbol>
    <symbol id="icon--chevron-down" viewBox="0 0 60 60">
      <title>icon--chevron-down icon</title>
      <title>icon--chevron-down</title>
		<path fill-rule="nonzero" d="M30 45l26-26-5-5-21 21L9 14l-5 5"></path>
    </symbol>
    ...
    <symbol id="icon--chevron-up" viewBox="0 0 60 60">
      ...
      <title>icon--chevron-up</title>
		<path fill-rule="nonzero" d="M30 14L4 40l5 5 21-21 21 21 5-5"></path>
    </symbol>
    <symbol id="icon--circle-around" viewBox="0 0 60 60">
      <title>icon--circle-around icon</title>
      <title>icon--circle-around</title>
		<g fill-rule="evenodd">
		<path
			d="M4.878 23.667c-.476 0-.862-.384-.862-.862V8.53c0-.767.928-1.153 1.47-.61l4.832 4.833c5.084-5.924 12.766-9.548 21.296-9.038 13.142.788 23.858 11.736 24.382 24.892.014.356-.012.704-.012 1.06h-5.998c0-1.248-.082-2.514-.322-3.804-1.474-7.954-7.862-14.348-15.814-15.836-7.74-1.45-14.866 1.61-19.272 6.984l5.184 5.19c.544.54.158 1.467-.608 1.467H4.878zm50.26 12c.477 0 .863.384.863.862v14.273c0 .768-.927 1.154-1.47.61L49.7 46.58c-5.085 5.925-12.767 9.55-21.297 9.04C15.26 54.83 4.545 43.882 4.02 30.726c-.013-.356.013-.704.015-1.06h5.996c0 1.248.085 2.514.323 3.804 1.476 7.955 7.864 14.35 15.814 15.837 7.74 1.45 14.866-1.61 19.272-6.984l-5.185-5.188c-.542-.54-.158-1.468.608-1.468H55.14z"></path></g>
    </symbol>
    <symbol id="icon--circle-back" viewBox="0 0 60 60">
      <title>icon--circle-back icon</title>
      <title>icon--circle-back</title>
		<g fill-rule="evenodd">
		<path
			d="M31.598 4.05c13.142.787 23.858 11.733 24.38 24.89C56.568 43.78 44.712 56 30 56c-10.652 0-19.786-6.417-23.802-15.59-.234-.535.06-1.16.614-1.347l3.808-1.27c.486-.162 1.002.078 1.216.546C15.002 45.212 21.948 50 30 50c12.274 0 22-11.113 19.646-23.805-1.474-7.952-7.86-14.348-15.814-15.836-7.738-1.45-14.862 1.61-19.272 6.983l5.186 5.188c.544.543.158 1.47-.608 1.47H4.862C4.386 24 4 23.616 4 23.14V8.862c0-.768.928-1.152 1.47-.608l4.832 4.832c5.086-5.924 12.764-9.55 21.296-9.038z"></path></g>
    </symbol>
    <symbol id="icon--circle-forward" viewBox="0 0 60 60">
      <title>icon--circle-forward icon</title>
      <title>icon--circle-forward</title>
		<g fill-rule="evenodd">
		<path
			d="M54.53 8.254c.543-.542 1.47-.158 1.47.61v14.274c0 .478-.385.862-.86.862H40.862c-.768 0-1.152-.928-.61-1.468l5.186-5.188C41.03 11.97 33.904 8.91 26.166 10.36c-7.952 1.488-14.34 7.882-15.814 15.836C8 38.886 17.727 50 30 50c8.053 0 14.997-4.788 18.163-11.662.216-.466.732-.708 1.218-.544l3.807 1.268c.554.186.85.814.616 1.348C49.787 49.582 40.653 56 30 56 15.29 56 3.43 43.782 4.02 28.94 4.546 15.784 15.26 4.836 28.404 4.048c8.53-.51 16.21 3.114 21.296 9.038l4.83-4.832z"></path></g>
    </symbol>
    <symbol id="icon--circle-loader" viewBox="0 0 52 52">
      <title>icon--circle-loader icon</title>
      <title>Page 1</title>
		<g fill-rule="evenodd" transform="rotate(75.7886 26 26)">
		<animateTransform attributeName="transform" type="rotate"
			from="0 26 26" to="360 26 26" dur="0.8s" repeatCount="indefinite"></animateTransform>
		<path
			d="M26 5.098C14.474 5.098 5.098 14.474 5.098 26c0 11.526 9.376 20.902 20.902 20.902 11.526 0 20.902-9.376 20.902-20.902 0-11.526-9.376-20.902-20.902-20.902M26 52C11.664 52 0 40.336 0 26S11.664 0 26 0s26 11.664 26 26-11.664 26-26 26"
			opacity=".1"></path>
		<path
			d="M42.582 11.967c-.652 0-1.304-.25-1.8-.748-3.95-3.95-9.2-6.123-14.782-6.123-1.408 0-2.548-1.14-2.548-2.548C23.452 1.14 24.592 0 26 0c6.946 0 13.474 2.705 18.384 7.615.996.996.996 2.608 0 3.604-.498.497-1.15.747-1.802.747"></path></g>
    </symbol>
    ...
    <symbol id="icon--code" viewBox="0 0 60 60">
      ...
      <title>icon--code</title>
		<g fill-rule="evenodd">
		<path
			d="M21.35 49.237L2.82 30.707c-.39-.39-.39-1.024 0-1.414l18.53-18.53c.39-.392 1.023-.392 1.413 0l2.474 2.474c.392.39.392 1.024 0 1.414L9.89 30l15.347 15.35c.392.39.392 1.02 0 1.413l-2.474 2.474c-.39.39-1.024.39-1.414 0zm15.887 0l-2.474-2.474c-.392-.392-.392-1.024 0-1.414L50.11 30 34.764 14.65c-.392-.39-.392-1.023 0-1.413l2.474-2.474c.39-.392 1.024-.392 1.414 0l18.53 18.53c.39.39.39 1.024 0 1.414l-18.53 18.53c-.39.39-1.023.39-1.413 0z"></path></g>
    </symbol>
    <symbol id="icon--collapse" viewBox="0 0 60 60">
      <title>icon--collapse icon</title>
      <title>icon--collapse</title>
		<path
			d="M43.19 20.864L54 10.054 49.947 6l-10.81 10.81-5.647-5.645c-.583-.583-1.578-.17-1.578.655v15.343c0 .51.412.925.925.925H48.18c.825 0 1.238-.995.655-1.578l-5.646-5.646zm-15.1 11.973V48.18c0 .825-.997 1.236-1.58.655l-5.646-5.646L10.054 54 6 49.947l10.81-10.81-5.645-5.65c-.58-.58-.17-1.577.655-1.577h15.343c.513 0 .927.414.927.927z"
			fill-rule="evenodd"></path>
    </symbol>
    <symbol id="icon--commissions" viewBox="0 0 60 60">
      <title>icon--commissions icon</title>
      <title>icon--commissions</title>
		<path
			d="M54 98c-24.3 0-44-19.7-44-44s19.7-44 44-44 44 19.7 44 44-19.7 44-44 44zm0-12c17.674 0 32-14.326 32-32S71.674 22 54 22 22 36.326 22 54s14.326 32 32 32z"
			fill-rule="nonzero"></path>
    </symbol>
    <symbol id="icon--compass" viewBox="0 0 60 60">
      ...
      <title>icon--compass</title>
		<g fill-rule="evenodd">
		<path
			d="M30 4c14.36 0 26 11.64 26 26S44.36 56 30 56 4 44.36 4 30 15.64 4 30 4zm0 46.5c11.304 0 20.5-9.196 20.5-20.5S41.304 9.5 30 9.5 9.5 18.696 9.5 30 18.696 50.5 30 50.5zm11.898-31.83c.02.052.05.096.062.154.036.174.034.358-.04.548l-6.104 15.87c-.102.264-.31.474-.574.574l-15.87 6.104c-.122.048-.246.07-.364.07-.66 0-1.192-.676-.928-1.362l6.104-15.87c.1-.264.31-.472.574-.574l15.87-6.104c.122-.048.244-.068.364-.068.046 0 .084.026.128.032.07.01.128.024.192.048.104.038.194.088.278.156.05.04.098.074.14.122.076.09.126.188.168.3zM24.236 35.764l8.326-3.202-5.124-5.124-3.202 8.326z"></path></g>
    </symbol>
    <symbol id="icon--confirmation" viewBox="0 0 52 52">
      <title>icon--confirmation icon</title>
      <title>icon--confirmation</title>
		<path
			d="M26 0C11.64 0 0 11.64 0 26s11.64 26 26 26 26-11.64 26-26c0-6.896-2.74-13.51-7.615-18.385C39.51 2.74 32.895 0 26 0zm14 16.8L23.02 37.26c-.11.115-.26.18-.42.18-.16 0-.31-.065-.42-.18l-10-8.68c-.115-.11-.18-.26-.18-.42 0-.16.065-.31.18-.42l1.6-1.74c.233-.23.607-.23.84 0l7.62 6.66 14.98-18.2c.226-.226.594-.226.82 0L39.86 16c.212.176.27.477.14.72v.08z"
			fill-rule="nonzero"></path>
    </symbol>
    ...
    <symbol id="icon--delta-down" viewBox="0 0 60 60">
      ...
      <title>icon--delta-down</title>
		<defs>
		<path id="a" d="M0 60h60V0H0z"></path></defs>
		<g fill-rule="evenodd">
		<path
			d="M13.05 20h33.9c.915 0 1.39 1.09.767 1.762L30.77 40.016c-.417.446-1.123.446-1.54 0L12.284 21.762C11.66 21.09 12.135 20 13.05 20z"></path></g>
    </symbol>
    <symbol id="icon--delta-left" viewBox="0 0 60 60">
      <title>icon--delta-left icon</title>
      <title>icon--delta-left</title>
		<g fill-rule="evenodd">
		<path
			d="M38 13.054v33.892c0 .918-1.094 1.396-1.766.772L17.984 30.77c-.448-.416-.448-1.124 0-1.54l18.25-16.946c.672-.626 1.766-.148 1.766.77z"></path></g>
    </symbol>
    <symbol id="icon--delta-right" viewBox="0 0 60 60">
      <title>icon--delta-right icon</title>
      <title>icon--delta-right</title>
		<g fill-rule="evenodd">
		<path
			d="M21.647 13.054c0-.918 1.094-1.396 1.766-.77l18.25 16.946c.448.416.448 1.124 0 1.54l-18.25 16.948c-.672.624-1.766.146-1.766-.772V13.054z"></path></g>
    </symbol>
    <symbol id="icon--delta-up" viewBox="0 0 60 60">
      <title>icon--delta-up icon</title>
      <title>icon--delta-up</title>
		<g fill-rule="evenodd">
		<path
			d="M13.054 40c-.918 0-1.396-1.094-.77-1.766l16.946-18.25c.416-.448 1.124-.448 1.54 0l16.948 18.25c.624.672.146 1.766-.772 1.766H13.054z"></path></g>
    </symbol>
    <symbol id="icon--download" viewBox="0 0 60 60">
      ...
      <title>icon--download</title>
		<g fill-rule="evenodd">
		<path
			d="M51 36h-4c-.552 0-1 .448-1 1v7H14v-7c0-.552-.448-1-1-1H9c-.552 0-1 .448-1 1v12c0 .552.448 1 1 1h42c.552 0 1-.448 1-1V37c0-.552-.448-1-1-1m-31.506-8.948c-.55-.592-.13-1.556.678-1.556h7.144V11.278c0-.552.448-1 1-1h3.56c.554 0 1 .448 1 1v14.218h6.974c.872 0 1.326 1.042.732 1.68L30.83 37.68c-.396.428-1.07.428-1.466 0l-9.87-10.628"></path></g>
    </symbol>
    <symbol id="icon--ellipsis" viewBox="0 0 60 60">
      <title>icon--ellipsis icon</title>
      <g fill-rule="nonzero">
		<circle cx="11.5" cy="30.5" r="5.5"></circle>
		<circle cx="30.5" cy="30.5" r="5.5"></circle>
		<circle cx="48.5" cy="30.5" r="5.5"></circle></g>
    </symbol>
    <symbol id="icon--expand" viewBox="0 0 60 60">
      <title>icon--expand icon</title>
      <title>icon--expand</title>
		<path
			d="M53.03 6H36.97c-.863 0-1.295 1.042-.685 1.654l5.91 5.908L30.88 24.878l4.24 4.244 11.317-11.318 5.91 5.91c.61.61 1.652.178 1.652-.684V6.968c0-.534-.433-.968-.97-.968zM29.12 35.122L17.806 46.438l5.91 5.91c.608.61.178 1.652-.686 1.652H6.97c-.537 0-.97-.434-.97-.968V36.97c0-.862 1.043-1.294 1.653-.684l5.91 5.91L24.88 30.878l4.24 4.244z"
			fill-rule="evenodd"></path>
    </symbol>
    <symbol id="icon--external" viewBox="0 0 60 60">
      ...
      <title>icon--external</title>
		<g fill-rule="evenodd">
		<path
			d="M51.03 8c.537 0 .97.434.97.968V25.03c0 .862-1.043 1.294-1.653.684l-6.086-6.086-21.607 21.61c-.392.39-1.024.39-1.414 0l-2.48-2.476c-.39-.39-.39-1.022 0-1.414L40.37 15.74l-6.085-6.086C33.675 9.042 34.107 8 34.97 8h16.06zM51 30c.552 0 1 .448 1 1v20c0 .552-.448 1-1 1H9c-.552 0-1-.448-1-1V9c0-.552.448-1 1-1h20c.552 0 1 .448 1 1v3.5c0 .552-.448 1-1 1H13.5v33h33V31c0-.552.448-1 1-1H51z"></path></g>
    </symbol>
    ...
    <symbol id="icon--flag" viewBox="0 0 60 60">
      ...
      <title>icon--flag</title>
		<g fill-rule="evenodd">
		<path
			d="M10 51V9c0-.552.448-1 1-1h4c.552 0 1 .448 1 1v42c0 .552-.448 1-1 1h-4c-.552 0-1-.448-1-1zM20 9c0-.552.448-1 1-1h15l2 4h11c.552 0 1 .448 1 1v20c0 .552-.448 1-1 1H36l-2-4H21c-.552 0-1-.448-1-1V9z"></path></g>
    </symbol>
    ...
    <symbol id="icon--graph-bar" viewBox="0 0 60 60">
      ...
      <title>icon--graph-bar</title>
		<g fill-rule="evenodd">
		<path
			d="M51 46c.552 0 1 .448 1 1v4c0 .552-.448 1-1 1H9c-.552 0-1-.448-1-1v-4c0-.552.448-1 1-1h42zm-38-4c-.552 0-1-.448-1-1V17c0-.552.448-1 1-1h4c.552 0 1 .448 1 1v24c0 .552-.448 1-1 1h-4zm10 0c-.552 0-1-.448-1-1V9c0-.552.448-1 1-1h4c.552 0 1 .448 1 1v32c0 .552-.448 1-1 1h-4zm10 0c-.552 0-1-.448-1-1V23c0-.552.448-1 1-1h4c.552 0 1 .448 1 1v18c0 .552-.448 1-1 1h-4zm10 0c-.552 0-1-.448-1-1V13c0-.552.448-1 1-1h4c.552 0 1 .448 1 1v28c0 .552-.448 1-1 1h-4z"></path></g>
    </symbol>
    <symbol id="icon--graph-line" viewBox="0 0 60 60">
      <title>icon--graph-line icon</title>
      <title>icon--graph-line</title>
		<g fill-rule="evenodd">
		<path
			d="M51.5 52h-43c-.276 0-.5-.224-.5-.5v-5c0-.276.224-.5.5-.5h43c.276 0 .5.224.5.5v5c0 .276-.224.5-.5.5zM11.6 41.2l-3.2-2.4c-.442-.332-.53-.958-.2-1.4l12.638-16.852c.338-.45.984-.532 1.424-.18l9.296 7.436 15.488-18.93c.348-.426.978-.49 1.406-.14l3.098 2.532c.426.35.49.98.14 1.408L33.07 35.43c-.346.424-.97.49-1.398.148l-9.128-7.302L13 41c-.33.442-.956.532-1.4.2z"></path></g>
    </symbol>
    <symbol id="icon--heart-outline" viewBox="0 0 60 60">
      <title>icon--heart-outline icon</title>
      <title>icon--heart outline</title>
		<path
			d="M18.817 12.55c-2.174 0-4.305.626-5.923 1.805-2.876 2.09-4.052 5.9-2.926 9.474.79 2.5 2.575 5.153 5.307 7.887C19.14 35.58 26.72 42.367 30 45.282c3.288-2.925 10.88-9.722 14.724-13.565 2.733-2.732 4.517-5.387 5.304-7.886 1.13-3.576-.046-7.384-2.924-9.476-2.28-1.657-5.574-2.224-8.596-1.48-3.326.842-5.213 3.668-6.043 5.276-.477.925-1.427 1.505-2.466 1.505-1.038 0-1.99-.58-2.465-1.503-.828-1.61-2.72-4.436-6.063-5.283-.87-.215-1.768-.32-2.655-.32zm12.42 33.828l.013.01-.014-.01zm-2.486.01l-.004.006.005-.005zM30 51.464c-.87 0-1.74-.31-2.434-.928-1.887-1.67-11.585-10.27-16.212-14.897-3.416-3.416-5.6-6.735-6.675-10.14-1.844-5.854.147-12.133 4.952-15.63 3.62-2.63 8.55-3.522 13.183-2.38 2.75.697 5.21 2.248 7.184 4.485 1.97-2.237 4.424-3.786 7.164-4.48 4.653-1.144 9.58-.258 13.202 2.376h.002c4.806 3.496 6.797 9.776 4.95 15.627-1.072 3.406-3.255 6.723-6.673 10.14-4.488 4.487-13.55 12.545-16.22 14.906-.692.613-1.557.92-2.424.92z"
			fill-rule="nonzero"></path>
    </symbol>
    <symbol id="icon--heart-thin-outline" viewBox="0 0 16 14">
      ...
      <title>Fill 1</title>
		<path
			d="M8.13 13.05h.002zM8 12.93c.722-.644 1.543-1.384 2.373-2.142 1.293-1.183 2.342-2.17 3.02-2.852.968-.975 1.633-1.94 1.94-2.924.446-1.42-.02-2.955-1.174-3.8-.903-.662-2.176-.877-3.334-.59-.997.254-1.84 1.01-2.38 2.067L8 3.563l-.445-.87C7.015 1.635 6.17.878 5.175.625c-1.16-.288-2.432-.073-3.334.588-1.154.845-1.62 2.38-1.174 3.8.308.986.973 1.95 1.94 2.925.68.683 1.73 1.67 3.02 2.852.832.76 1.667 1.51 2.374 2.142z"
			stroke="#A0A0A0" fill-rule="evenodd"></path>
    </symbol>
    ...
    <symbol id="icon--home" viewBox="0 0 60 60">
      ...
      <title>icon--home</title>
		<g fill-rule="evenodd">
		<path
			d="M29.088 6.296c.394-.394 1.034-.394 1.428 0l24.188 23.792c.634.634.184 1.72-.714 1.72h-5.634v21.184c0 .556-.454 1.008-1.01 1.008H12.654c-.556 0-1.01-.452-1.01-1.008V31.808H6.01c-.898 0-1.348-1.086-.714-1.72L29.088 6.296z"></path></g>
    </symbol>
    <symbol id="icon--human" viewBox="0 0 60 60">
      ...
      <title>icon--human</title>
		<g fill-rule="evenodd">
		<path
			d="M42 18c0 6.626-5.374 12-12 12s-12-5.374-12-12S23.374 6 30 6s12 5.374 12 12zM10 52v-8.278C14.982 38.984 22.086 36 30 36s15.018 2.984 20 7.722V52H10z"></path></g>
    </symbol>
    <symbol id="icon--humans" viewBox="0 0 60 60">
      <title>icon--humans icon</title>
      <title>icon--humans</title>
		<g fill-rule="evenodd">
		<path
			d="M20 32c-6.074 0-11-4.924-11-11s4.926-11 11-11 11 4.924 11 11-4.926 11-11 11zm24 0c-4.418 0-8-3.582-8-8s3.582-8 8-8 8 3.582 8 8-3.582 8-8 8zm-24 4.182c7.124 0 11.516 3.052 16 7.896V52H4v-7.922c4.484-4.844 8.876-7.896 16-7.896zM42 36c5.54 0 10.512 2.238 14 5.792V52H40v-9.488l-1.064-1.148c-1.294-1.4-2.684-2.748-4.212-3.982C36.968 36.504 39.418 36 42 36z"></path></g>
    </symbol>
    <symbol id="icon--image" viewBox="0 0 60 60">
      ...
      <title>icon--image</title>
		<g fill-rule="evenodd">
		<path
			d="M4 9c0-.552.448-1 1-1h50c.552 0 1 .448 1 1v42c0 .552-.448 1-1 1H5c-.552 0-1-.448-1-1V9zm5.5 37.5h41v-33h-41v33zm4.734-6.227l6.376-7.97c.398-.496 1.136-.536 1.582-.088l5.536 5.534 7.586-11.38c.43-.643 1.378-.63 1.786.027l8.736 13.978c.442.706-.066 1.624-.9 1.624H15.064c-.89 0-1.386-1.03-.83-1.727zM24 24c0 2.208-1.792 4-4 4s-4-1.792-4-4 1.792-4 4-4 4 1.792 4 4z"></path></g>
    </symbol>
    <symbol id="icon--inbox" viewBox="0 0 60 60">
      ...
      <title>icon--inbox</title>
		<g fill-rule="evenodd">
		<path
			d="M17.254 14h25.492l3.2 24h-9.004c-.482 0-.932.334-.996.812C35.546 41.738 33.034 44 30 44s-5.546-2.262-5.946-5.188c-.064-.478-.512-.812-.996-.812h-9.006l3.202-24zm34.744 24L48.114 8.868c-.068-.496-.488-.868-.99-.868H12.876c-.5 0-.924.372-.992.868L8 38l-.002 13c0 .552.448 1 1 1H51c.276 0 .526-.112.708-.292.18-.182.292-.432.292-.708V38h-.002z"></path></g>
    </symbol>
    ...
    <symbol id="icon--lock" viewBox="0 0 60 60">
      ...
      <title>icon--lock</title>
		<g fill-rule="evenodd">
		<path
			d="M40 26H20v-6.776c0-5.318 4.486-9.644 10-9.644s10 4.326 10 9.644V26zm9 0h-3v-6.776C46 10.598 38.822 3.58 30 3.58s-16 7.018-16 15.644V26h-3c-.552 0-1 .448-1 1v24c0 .552.448 1 1 1h38c.552 0 1-.448 1-1V27c0-.552-.448-1-1-1z"></path></g>
    </symbol>
    <symbol id="icon--mail" viewBox="0 0 60 60">
      ...
      <title>icon--mail</title>
		<g fill-rule="evenodd">
		<path
			d="M30 31.39L8.138 12.88c-.356-.3-.142-.88.322-.88h43.08c.464 0 .676.58.322.88L30 31.39zM4.823 15.317l16.75 14.176-16.74 15.064c-.32.29-.834.06-.834-.37v-28.49c0-.424.497-.656.823-.38zm50.355 0c.324-.276.822-.044.822.38v28.49c0 .43-.512.66-.834.37L38.43 29.496l16.748-14.178zm-19.83 16.786L52.044 47.13c.34.306.122.87-.336.87H8.292c-.458 0-.674-.564-.334-.87l16.696-15.028 3.428 2.902c.554.462 1.232.694 1.914.694.686 0 1.372-.234 1.936-.704l3.416-2.89z"></path></g>
    </symbol>
    <symbol id="icon--menu" viewBox="0 0 60 60">
      ...
      <title>icon--menu</title>
		<g fill-rule="evenodd">
		<path
			d="M51 48H9c-.552 0-1-.448-1-1v-4c0-.552.448-1 1-1h42c.552 0 1 .448 1 1v4c0 .552-.448 1-1 1zm-8-15H9c-.552 0-1-.448-1-1v-4c0-.552.448-1 1-1h34c.552 0 1 .448 1 1v4c0 .552-.448 1-1 1zm8-15H9c-.552 0-1-.448-1-1v-4c0-.552.448-1 1-1h42c.552 0 1 .448 1 1v4c0 .552-.448 1-1 1z"></path></g>
    </symbol>
    <symbol id="icon--message" viewBox="0 0 60 60">
      ...
      <title>icon--message</title>
		<g fill-rule="evenodd">
		<path
			d="M55 8c.552 0 1 .448 1 1v34c0 .552-.448 1-1 1H36L21.83 55.73c-.718.618-1.83.106-1.83-.842V44H5c-.552 0-1-.448-1-1V9c0-.552.448-1 1-1h50z"></path></g>
    </symbol>
    <symbol id="icon--mobile" viewBox="0 0 60 60">
      ...
      <title>icon--mobile</title>
		<g fill-rule="evenodd">
		<path
			d="M17.5 44h25V12h-25v32zM34 51c0 .552-.448 1-1 1h-6c-.552 0-1-.448-1-1v-2c0-.552.448-1 1-1h6c.552 0 1 .448 1 1v2zM47.316 5.764c-.286-.426-.654-.794-1.08-1.08C45.598 4.252 44.828 4 44 4H16c-.828 0-1.598.252-2.236.684-.426.286-.794.654-1.08 1.08C12.252 6.402 12 7.172 12 8v44c0 2.208 1.792 4 4 4h28c2.208 0 4-1.792 4-4V8c0-.828-.252-1.598-.684-2.236z"></path></g>
    </symbol>
    <symbol id="icon--overflow" viewBox="0 0 60 60">
      <title>icon--overflow icon</title>
      <title>icon--overflow</title>
		<g fill-rule="nonzero">
		<circle cx="29.5" cy="11.5" r="5.5"></circle>
		<circle cx="29.5" cy="30.5" r="5.5"></circle>
		<circle cx="29.5" cy="48.5" r="5.5"></circle></g>
    </symbol>
    <symbol id="icon--pause" viewBox="0 0 60 60">
      <title>icon--pause icon</title>
      <title>icon--pause</title>
		<g fill-rule="evenodd">
		<rect x="11" y="7" width="14" height="44" rx="1"></rect>
		<rect x="36" y="7" width="14" height="44" rx="1"></rect></g>
    </symbol>
    <symbol id="icon--pencil" viewBox="0 0 60 60">
      ...
      <title>icon--pencil</title>
		<g fill-rule="evenodd">
		<path
			d="M46.242 22.242l-8.484-8.484c-.39-.39-.39-1.024 0-1.416l4.648-4.646c.39-.392 1.024-.392 1.414 0l8.484 8.484c.392.39.392 1.024 0 1.414l-4.648 4.648c-.39.39-1.024.39-1.414 0zm-12.908-5.478c.39-.39 1.024-.388 1.414 0l8.486 8.49c.392.388.392 1.02.002 1.412L18 52H9c-.552 0-1-.446-1-1v-9l25.334-25.236z"></path></g>
    </symbol>
    <symbol id="icon--pin" viewBox="0 0 60 60">
      ...
      <title>icon--pin</title>
		<g fill-rule="evenodd">
		<path
			d="M39.778 24.01C43.22 24.052 46 26.85 46 30.304V31c0 .553-.448 1-1 1H15c-.554 0-1-.447-1-1v-.695c0-3.454 2.778-6.252 6.222-6.296L22 8l-1.638-3.277c-.168-.332.076-.722.446-.722h18.384c.37 0 .612.39.446.723L38 8l1.778 16.01zM32.5 36c.276 0 .5.224.5.5l-2 19c0 .276-.224.5-.5.5h-1c-.276 0-.5-.224-.5-.5l-2-19c0-.276.224-.5.5-.5h5z"></path></g>
    </symbol>
    ...
    <symbol id="icon--play" viewBox="0 0 60 60">
      ...
      <title>icon--play</title>
		<g fill-rule="evenodd">
		<path
			d="M8.003 9.03c0-.78.836-1.277 1.522-.903l41.938 22.876c.746.406.706 1.488-.066 1.84L9.457 51.905c-.68.312-1.454-.186-1.454-.934V9.03z"></path></g>
    </symbol>
    <symbol id="icon--plus-human" viewBox="0 0 60 60">
      <title>icon--plus-human icon</title>
      <title>icon--plus-human</title>
		<g fill-rule="evenodd">
		<path
			d="M50 20c0 6.626-5.374 12-12 12s-12-5.374-12-12S31.374 8 38 8s12 5.374 12 12zM19 54c-.552 0-1-.448-1-1v-6.83c0-.286.118-.56.326-.752C23.29 40.858 30.258 38 38 38c7.742 0 14.708 2.856 19.674 7.416.208.194.326.468.326.754V53c0 .552-.448 1-1 1H19zm2-26c.552 0 1 .448 1 1v2c0 .552-.448 1-1 1h-7v7c0 .552-.448 1-1 1h-2c-.552 0-1-.448-1-1v-7H3c-.552 0-1-.448-1-1v-2c0-.552.448-1 1-1h7v-7c0-.552.448-1 1-1h2c.552 0 1 .448 1 1v7h7z"></path></g>
    </symbol>
    <symbol id="icon--plus" viewBox="0 0 60 60">
      ...
      <title>icon--plus</title>
		<g fill-rule="evenodd">
		<path
			d="M51 27c.552 0 1 .448 1 1v4c0 .552-.448 1-1 1H33v18c0 .552-.448 1-1 1h-4c-.552 0-1-.448-1-1V33H9c-.552 0-1-.448-1-1v-4c0-.552.448-1 1-1h18V9c0-.552.448-1 1-1h4c.552 0 1 .448 1 1v18h18z"></path></g>
    </symbol>
    <symbol id="icon--prohibit" viewBox="0 0 60 60">
      <title>icon--prohibit icon</title>
      <title>icon--prohibit</title>
		<g fill-rule="evenodd">
		<path
			d="M30 50c11.028 0 20-8.972 20-20 0-4.434-1.466-8.52-3.918-11.84L18.16 46.082C21.48 48.534 25.566 50 30 50zm0-40c-11.028 0-20 8.972-20 20 0 4.434 1.466 8.52 3.918 11.84L41.84 13.918C38.52 11.466 34.434 10 30 10zm0-6c14.36 0 26 11.64 26 26S44.36 56 30 56 4 44.36 4 30 15.64 4 30 4z"></path></g>
    </symbol>
    <symbol id="icon--pull-quote" viewBox="0 0 60 60">
      <title>icon--pull-quote icon</title>
      <title>icon--pull-quote</title>
		<path
			d="M25.365 12v7.232c-4.708.964-7.064 4.232-7.064 9.804h7.065V48H8V31.446C8 19.338 13.79 12.858 25.364 12M52 12v7.232c-4.71.964-7.065 4.232-7.065 9.804H52V48H34.634V31.446C34.635 19.338 40.423 12.858 52 12"
			fill-rule="evenodd"></path>
    </symbol>
    <symbol id="icon--question-filled" viewBox="0 0 60 60">
      <title>icon--question-filled icon</title>
      <title>icon--question-filled</title>
		<path
			d="M30 56C15.64 56 4 44.36 4 30S15.64 4 30 4s26 11.64 26 26-11.64 26-26 26zm-2.692-21h4.066v-1.178c0-1.862 1.52-2.584 3.534-3.952 2.09-1.406 3.914-2.85 3.914-6.536 0-4.18-3.61-7.334-8.436-7.334-6.308 0-9.31 3.876-9.386 9.006l4.256.418c.152-2.584 1.178-5.282 5.016-5.282 3.116 0 4.218 1.786 4.218 3.458 0 2.394-1.71 3.42-3.572 4.674-2.052 1.33-3.61 2.546-3.61 5.244V35zm-.38 8.17h5.244v-5.054h-5.244v5.054z"
			fill-rule="evenodd"></path>
    </symbol>
    ...
    <symbol id="icon--reorder" viewBox="0 0 60 60">
      ...
      <title>icon-reorder</title>
		<defs>
		<path
			d="M16.017 8.418L8.7.538c-.27-.29-.73-.29-1 0L.383 8.42c-.408.438-.097 1.148.5 1.148H6.15V34.85c0 .378.306.683.683.683h2.733c.38 0 .684-.305.684-.683V9.566h5.267c.596 0 .906-.71.5-1.148"
			id="a"></path>
		<path
			d="M16.017 8.418L8.7.538c-.27-.29-.73-.29-1 0L.383 8.42c-.408.438-.097 1.148.5 1.148H6.15V34.85c0 .378.306.683.683.683h2.733c.38 0 .684-.305.684-.683V9.566h5.267c.596 0 .906-.71.5-1.148"
			id="c"></path></defs>
		<g fill-rule="evenodd">
		<g stroke="#979797" stroke-width=".1">
		<path d="M0 0h60v4H0z"></path>
		<path d="M0 0h4v60H0zM56 0h4v60h-4z"></path>
		<path d="M0 56h60v4H0z"></path>
		<circle cx="30" cy="30" r="26"></circle>
		<path d="M12 4h36v52H12z"></path>
		<path d="M4 12h52v36H4z"></path>
		<path d="M8.05 8.05h43.9v43.9H8.05z"></path></g>
		<g transform="translate(22.3 7.733)">
		<mask id="b">
		<use xlink:href="#a"></use></mask>
		<use xlink:href="#a"></use>
		<path d="M0 0h41v41H0z" transform="translate(-12.3 -2.733)"
			mask="url(#b)"></path></g>
		<g transform="rotate(-180 19.35 26.133)">
		<mask id="d">
    ...
    <symbol id="icon--reply" viewBox="0 0 60 60">
      ...
      <title>icon--reply</title>
		<g fill-rule="evenodd">
		<path
			d="M55.738 28.182c.478.44.478 1.196 0 1.636L31.86 51.708c-.712.652-1.86.146-1.86-.818V38.152c-13.012.93-18.378 6.538-23.866 15.3-.63 1.01-2.154.532-2.154-.664 0-22.45 13.14-32.74 26.02-34.486V7.112c0-.966 1.148-1.47 1.86-.818l23.878 21.888z"></path></g>
    </symbol>
    <symbol id="icon--save" viewBox="0 0 60 60">
      <title>icon--save icon</title>
      <title>icon--save</title>
		<path
			d="M21.2 9.1v11c0 .608.492 1.1 1.1 1.1h15.4c.608 0 1.1-.492 1.1-1.1v-11c0-.608.492-1.1 1.1-1.1h1.477c1.167 0 2.287.464 3.112 1.29l6.22 6.22c.826.826 1.29 1.946 1.29 3.113V47.6c0 2.43-1.97 4.4-4.4 4.4H12.4C9.97 52 8 50.03 8 47.6V12.4C8 9.97 9.97 8 12.4 8h7.7c.608 0 1.1.492 1.1 1.1zM30 43.2c3.645 0 6.6-2.955 6.6-6.6 0-3.645-2.955-6.6-6.6-6.6-3.645 0-6.6 2.955-6.6 6.6 0 3.645 2.955 6.6 6.6 6.6zM31.222 8h2.445c.675 0 1.222.547 1.222 1.222v7.334c0 .675-.548 1.222-1.223 1.222h-2.445c-.675 0-1.222-.547-1.222-1.222V9.222C30 8.547 30.547 8 31.222 8z"
			fill-rule="nonzero"></path>
    </symbol>
    <symbol id="icon--saved" viewBox="0 0 60 60">
      ...
      <title>icon--saved</title>
		<path
			d="M21.2 9.1v11c0 .608.492 1.1 1.1 1.1h15.4c.608 0 1.1-.492 1.1-1.1v-11c0-.608.492-1.1 1.1-1.1h1.477c1.167 0 2.287.464 3.112 1.29l6.22 6.22c.826.826 1.29 1.946 1.29 3.113V47.6c0 2.43-1.97 4.4-4.4 4.4H12.4C9.97 52 8 50.03 8 47.6V12.4C8 9.97 9.97 8 12.4 8h7.7c.608 0 1.1.492 1.1 1.1zm5.83 34.944c.174.152.44.13.587-.05l11.76-14.28c.146-.176.12-.434-.054-.578l-1.267-1.043c-.174-.143-.432-.12-.577.056L27.06 40.8l-5.3-4.638c-.17-.15-.43-.132-.578.038l-1.08 1.236c-.15.17-.132.43.038.578l6.89 6.03zM31.222 8h2.445c.675 0 1.222.547 1.222 1.222v7.334c0 .675-.548 1.222-1.223 1.222h-2.445c-.675 0-1.222-.547-1.222-1.222V9.222C30 8.547 30.547 8 31.222 8z"
			fill-rule="nonzero"></path>
    </symbol>
    ...
    <symbol id="icon--star" viewBox="0 0 60 60">
      ...
      <title>icon--star</title>
		<g fill-rule="evenodd">
		<path
			d="M56.874 23.44c.442.036.62.586.286.876L43.042 36.564c-.188.162-.27.416-.212.658l4.226 17.954c.136.576-.49 1.032-.998.724l-15.712-9.544c-.212-.128-.48-.128-.692 0L13.942 55.9c-.508.308-1.136-.148-.998-.724l4.226-17.954c.058-.242-.024-.496-.212-.658L3.736 25.094c-.668-.58-.31-1.68.572-1.752l17.378-1.444c.248-.02.466-.178.562-.41L29.382 4.41c.23-.548 1.006-.548 1.236 0l7.134 17.078c.096.232.312.39.562.41l18.56 1.542z"></path></g>
    </symbol>
    <symbol id="icon--subtitles-captions" viewBox="0 0 60 60">
      <title>icon--subtitles-captions icon</title>
      <title>icon--subtitles-captions</title>
		<path
			d="M55 8c.552 0 1 .448 1 1v34c0 .552-.448 1-1 1H36L21.83 55.73c-.718.618-1.83.106-1.83-.842V44H5c-.552 0-1-.448-1-1V9c0-.552.448-1 1-1h50zM12 18v6h24v-6H12zm30 0v6h6v-6h-6zM12 30v6h6v-6h-6zm12 0v6h24v-6H24z"
			fill-rule="nonzero"></path>
    </symbol>
    <symbol id="icon--text-bold" viewBox="0 0 60 60">
      ...
      <title>icon--text-bold</title>
		<path
			d="M14 52V8h17.488c3.888 0 7.008 1.1 9.36 3.298 2.353 2.2 3.527 4.955 3.527 8.27 0 2.086-.506 3.856-1.518 5.308s-2.315 2.577-3.912 3.374v.124c1.944.716 3.606 1.963 4.987 3.743 1.38 1.78 2.07 4.01 2.07 6.69 0 1.963-.28 3.72-.843 5.276-.565 1.556-1.448 2.942-2.655 4.158-1.208 1.218-2.85 2.15-4.924 2.794-2.076.644-4.547.966-7.41.966H14zm6.29-5.767h8.866c1.7 0 3.145-.104 4.343-.308 1.195-.205 2.285-.574 3.267-1.105.98-.532 1.72-1.293 2.21-2.287.49-.99.734-2.234.734-3.726 0-2.66-.853-4.512-2.56-5.554-1.708-1.043-4.332-1.566-7.87-1.566h-8.99v14.546zm0-19.946h10.186c5.072 0 7.61-2.066 7.61-6.197 0-2.026-.675-3.57-2.025-4.634-1.35-1.064-3.23-1.596-5.645-1.596H20.29v12.427z"
			fill-rule="evenodd"></path>
    </symbol>
    <symbol id="icon--text-bullet" viewBox="0 0 60 60">
      <title>icon--text-bullet icon</title>
      <title>icon--text-bullet</title>
		<path
			d="M52 47v-4c0-.552-.448-1-1-1H21c-.552 0-1 .448-1 1v4c0 .552.448 1 1 1h30c.552 0 1-.448 1-1m0-15v-4c0-.552-.448-1-1-1H21c-.552 0-1 .448-1 1v4c0 .552.448 1 1 1h30c.552 0 1-.448 1-1m0-15v-4c0-.552-.448-1-1-1H21c-.552 0-1 .448-1 1v4c0 .552.448 1 1 1h30c.552 0 1-.448 1-1m-38 0v-4c0-.552-.448-1-1-1H9c-.552 0-1 .448-1 1v4c0 .552.448 1 1 1h4c.552 0 1-.448 1-1m0 15v-4c0-.552-.448-1-1-1H9c-.552 0-1 .448-1 1v4c0 .552.448 1 1 1h4c.552 0 1-.448 1-1m-1 16H9c-.552 0-1-.448-1-1v-4c0-.552.448-1 1-1h4c.552 0 1 .448 1 1v4c0 .552-.448 1-1 1"
			fill-rule="evenodd"></path>
    </symbol>
    <symbol id="icon--text-italic" viewBox="0 0 60 60">
      ...
      <title>icon--text-italic</title>
		<path
			d="M34.83 19.948h-1.458l-9.15 1.982-.35 1.224 4.43 1.806-4.486 18.066C23.29 45.24 23 46.698 23 48.038 23 50.426 24.398 52 26.614 52c2.914 0 5.478-1.748 9.032-7.05l-1.166-1.224c-2.622 3.204-4.312 4.37-5.42 4.37-.524 0-.816-.29-.816-.874 0-.466.234-1.458.526-2.566l6.06-24.708zM33.2 15.81c2.212 0 4.078-1.864 4.078-4.138 0-2.04-1.574-3.672-3.672-3.672-2.214 0-4.078 1.866-4.078 4.138 0 2.04 1.572 3.672 3.672 3.672z"
			fill-rule="evenodd"></path>
    </symbol>
    <symbol id="icon--textalign-centered" viewBox="0 0 60 60">
      <title>icon--textalign-centered icon</title>
      <title>icon--textalign-centered</title>
		<path
			d="M51 12c.552 0 1 .448 1 1v4c0 .552-.448 1-1 1H9c-.552 0-1-.448-1-1v-4c0-.552.448-1 1-1h42zm-4 21H13c-.552 0-1-.448-1-1v-4c0-.552.448-1 1-1h34c.552 0 1 .448 1 1v4c0 .552-.448 1-1 1zm4 9c.552 0 1 .448 1 1v4c0 .552-.448 1-1 1H9c-.552 0-1-.448-1-1v-4c0-.552.448-1 1-1h42z"
			fill-rule="evenodd"></path>
    </symbol>
    <symbol id="icon--textalign-right" viewBox="0 0 60 60">
      <title>icon--textalign-right icon</title>
      <title>icon--textalign-right</title>
		<path
			d="M51 42H9c-.552 0-1 .448-1 1v4c0 .552.448 1 1 1h42c.552 0 1-.448 1-1v-4c0-.552-.448-1-1-1zm0-9c.552 0 1-.448 1-1v-4c0-.552-.448-1-1-1H17c-.552 0-1 .448-1 1v4c0 .552.448 1 1 1h34zm1-20v4c0 .552-.448 1-1 1H9c-.552 0-1-.448-1-1v-4c0-.552.448-1 1-1h42c.552 0 1 .448 1 1z"
			fill-rule="evenodd"></path>
    </symbol>
    <symbol id="icon--thumbs-down" viewBox="0 0 60 60">
      ...
      <title>icon--thumbs-down</title>
		<path
			d="M44 11h6c1.33 0 2 .7 2 2v21c0 1.302-.67 2-2 2h-6c-.33 0-1-.698-1-2V13c0-1.3.67-2 1-2zm-27 0h20c1.31 0 2 .708 2 2v22c0 .09-.106.422 0 1l-9 11c-.545 1.345-1.873 2-3 2-2.873 0-4.966-2.15-5-5v-8h-8c-1.632.334-3.424-.583-5-2-.777-1.784-1.144-3.81-1-6l4-14c.796-1.583 2.624-3 5-3z"
			fill-rule="nonzero"></path>
    </symbol>
    <symbol id="icon--thumbs-up" viewBox="0 0 60 60">
      ...
      <title>icon--thumbs-up</title>
		<path
			d="M52 32l-4 14c-.753 1.583-2.585 3-5 3H23c-1.31 0-2-.71-2-2V25c0-.09.107-.422 0-1l9-11c.56-1.345 1.89-2 3-2 2.897 0 4.994 2.15 5 5v8h8c1.676-.333 3.47.583 5 2 .827 1.784 1.196 3.81 1 6zm-36-8c.33 0 1 .7 1 2v21c0 1.3-.67 2-1 2h-6c-1.33 0-2-.7-2-2V26c0-1.3.67-2 2-2h6z"
			fill-rule="nonzero"></path>
    </symbol>
    <symbol id="icon--thumbsdown-outline" viewBox="0 0 15 15">
      <title>icon--thumbsdown-outline icon</title>
      <title>icon--thumbsdown-outline</title>
		<path
    ...
    <symbol id="icon--thumbsup-outline" viewBox="0 0 15 15">
      ...
      <title>icon--thumbsup-outline</title>
		<path
    ...
    <symbol id="icon--trash" viewBox="0 0 60 60">
      ...
      <title>icon--trash</title>
		<g fill-rule="evenodd">
		<path
			d="M49 10c.552 0 1 .448 1 1v4c0 .552-.448 1-1 1H11c-.552 0-1-.448-1-1v-4c0-.552.448-1 1-1h9l1.722-3.448c.17-.338.516-.552.896-.552h14.764c.38 0 .726.214.896.552L40 10h9zM15.82 50.4L12 20h36l-3.82 30.4c-.102.907-.964 1.6-1.99 1.6H17.81c-1.028 0-1.888-.693-1.99-1.6z"></path></g>
    </symbol>
    ...
    <symbol id="icon--twitter" viewBox="0 0 60 60">
      ...
      <title>icon--twitter</title>
		<g fill-rule="evenodd">
		<path
			d="M4.11 46.748c.775.12 1.62.178 2.533.178 2.364 0 4.678-.458 6.942-1.37 2.264-.912 4.35-2.136 6.258-3.674-2.28-.014-4.336-.72-6.17-2.114-1.832-1.394-3.078-3.154-3.736-5.284.71.136 1.368.204 1.976.204.98 0 1.926-.128 2.838-.382-2.45-.488-4.485-1.708-6.105-3.66-1.622-1.95-2.434-4.21-2.434-6.776v-.128c1.523.826 3.127 1.266 4.815 1.316-1.468-.978-2.63-2.246-3.484-3.8-.85-1.552-1.277-3.224-1.277-5.016 0-1.74.48-3.462 1.444-5.17 2.668 3.244 5.894 5.816 9.678 7.718 3.784 1.9 7.864 2.968 12.238 3.204-.152-.66-.228-1.478-.228-2.458 0-2.94 1.036-5.444 3.104-7.512 2.067-2.07 4.573-3.104 7.51-3.104 3.025 0 5.635 1.116 7.83 3.344 2.417-.49 4.655-1.352 6.715-2.584-.81 2.566-2.372 4.534-4.688 5.904 2.112-.238 4.156-.802 6.132-1.7-1.42 2.148-3.183 3.988-5.297 5.524v1.394c0 2.366-.3 4.742-.898 7.134-.6 2.39-1.462 4.712-2.584 6.966-1.123 2.256-2.563 4.364-4.32 6.322-1.757 1.96-3.725 3.67-5.903 5.132-2.18 1.46-4.692 2.612-7.538 3.458-2.847.844-5.85 1.266-9.01 1.266-6.4 0-11.847-1.444-16.34-4.332z"></path></g>
    </symbol>
    <symbol id="icon--unlink" viewBox="0 0 60 60">
      <title>icon--unlink icon</title>
      <title>Artboard</title>
		<path
			d="M18.186 26.637l4.5 4.484-7.402 7.402c-1.24 1.242-1.24 3.252 0 4.492l1.498 1.498c1.24 1.24 3.252 1.24 4.492 0l3.108-3.108c.39-.39 1.024-.39 1.414 0l3.078 3.078c.39.39.39 1.024 0 1.414l-3.108 3.108c-3.722 3.722-9.756 3.722-13.476 0l-1.498-1.498c-3.72-3.72-3.72-9.754 0-13.476l7.394-7.393zm23.397 6.55l-4.484-4.5 7.412-7.415c1.242-1.24 1.242-3.25 0-4.492l-1.496-1.496c-1.24-1.242-3.252-1.242-4.492 0l-3.162 3.16c-.39.39-1.024.39-1.414 0l-3.078-3.078c-.39-.39-.39-1.024 0-1.414l3.162-3.162c3.72-3.72 9.754-3.72 13.476 0l1.496 1.498c3.724 3.722 3.724 9.756 0 13.476l-7.42 7.423zM15.15 10.907L49.093 44.85c.39.39.39 1.023 0 1.413l-2.83 2.83c-.39.39-1.022.39-1.413 0L10.907 15.15c-.39-.39-.39-1.023 0-1.413l2.83-2.83c.39-.39 1.022-.39 1.413 0z"
			fill-rule="nonzero"></path>
    </symbol>
    <symbol id="icon--unlock" viewBox="0 0 60 60">
      ...
      <title>icon--unlock</title>
		<g fill-rule="evenodd">
		<path
			d="M49 26H20v-6.776c0-5.318 4.486-9.644 10-9.644 4.854 0 8.914 3.284 9.816 7.78.104.518.552.894 1.08.844l3.992-.396c.566-.056.994-.578.9-1.138C44.534 9.138 37.924 3.58 30 3.58c-8.822 0-16 7.018-16 15.644V26h-3c-.552 0-1 .448-1 1v24c0 .552.448 1 1 1h38c.552 0 1-.448 1-1V27c0-.552-.448-1-1-1"></path></g>
    </symbol>
    <symbol id="icon--update-freeform-round" viewBox="0 0 60 60">
      ...
      <title>icon--update-freeform-round</title>
		<path
			d="M30 52C17.85 52 8 42.15 8 30S17.85 8 30 8s22 9.85 22 22-9.85 22-22 22zm-9-32c-.552 0-1 .448-1 1v1c0 .552.448 1 1 1h13c.552 0 1-.448 1-1v-1c0-.552-.448-1-1-1H21zm0 6c-.552 0-1 .448-1 1v1c0 .552.448 1 1 1h18c.552 0 1-.448 1-1v-1c0-.552-.448-1-1-1H21zm0 6c-.552 0-1 .448-1 1v1c0 .552.448 1 1 1h18c.552 0 1-.448 1-1v-1c0-.552-.448-1-1-1H21zm0 6c-.552 0-1 .448-1 1v1c0 .552.448 1 1 1h6c.552 0 1-.448 1-1v-1c0-.552-.448-1-1-1h-6z"
			fill-rule="evenodd"></path>
    </symbol>
    <symbol id="icon--update-freeform" viewBox="0 0 60 60">
      <title>icon--update-freeform icon</title>
      <title>icon--update-freeform</title>
		<path
			d="M12.095 11h25.81c1.157 0 2.095.938 2.095 2.095v.81C40 15.062 39.062 16 37.905 16h-25.81C10.938 16 10 15.062 10 13.905v-.81c0-1.157.938-2.095 2.095-2.095zm0 11h35.81c1.157 0 2.095.938 2.095 2.095v.81C50 26.062 49.062 27 47.905 27h-35.81C10.938 27 10 26.062 10 24.905v-.81c0-1.157.938-2.095 2.095-2.095zm0 11h35.81c1.157 0 2.095.938 2.095 2.095v.81C50 37.062 49.062 38 47.905 38h-35.81C10.938 38 10 37.062 10 35.905v-.81c0-1.157.938-2.095 2.095-2.095zm0 11h11.81c1.157 0 2.095.938 2.095 2.095v.81C26 48.062 25.062 49 23.905 49h-11.81C10.938 49 10 48.062 10 46.905v-.81c0-1.157.938-2.095 2.095-2.095z"
			fill-rule="evenodd"></path>
    </symbol>
    ...
    <symbol id="icon--update-qa-round" viewBox="0 0 60 60">
      ...
      <title>icon--update-qa-round</title>
		<path
			d="M30 52C17.85 52 8 42.15 8 30S17.85 8 30 8s22 9.85 22 22-9.85 22-22 22zm2.402-18.69h8.85c1.192 0 1.61-.43 1.61-1.65v-9.89c0-1.22-.418-1.65-1.61-1.65h-8.85c-1.19 0-1.61.43-1.61 1.65v9.89c0 1.22.42 1.65 1.61 1.65zm-12.816 7.81l4.31-4.293h-4.31v4.294zm-1.84-4.293H26.6c1.19 0 1.61-.43 1.61-1.65v-9.89c0-1.22-.42-1.65-1.61-1.65h-8.85c-1.192 0-1.61.43-1.61 1.65v9.89c0 1.22.418 1.65 1.61 1.65zm21.668.863v-4.38h-4.31l4.31 4.38z"
			fill-rule="evenodd"></path>
    </symbol>
    <symbol id="icon--update-qa" viewBox="0 0 60 60">
      <title>icon--update-qa icon</title>
      <title>icon--update-qa</title>
		<path
			d="M34.667 37C32.693 37 32 36.285 32 34.25v-16.5c0-2.035.693-2.75 2.667-2.75h14.666c1.974 0 2.667.715 2.667 2.75v16.5c0 2.035-.693 2.75-2.667 2.75H34.667zM13 49v-7h7l-7 7zm-2.333-7C8.693 42 8 41.285 8 39.25v-16.5c0-2.035.693-2.75 2.667-2.75h14.666c1.974 0 2.667.715 2.667 2.75v16.5c0 2.035-.693 2.75-2.667 2.75H10.667zM46 44l-7-7h7v7z"
			fill-rule="nonzero"></path>
    </symbol>
    ...
    <symbol id="icon--video" viewBox="0 0 60 60">
      ...
      <title>icon--video</title>
		<g fill-rule="evenodd">
		<path
			d="M9.5 35.25h41V13.5h-41v21.75zm35 11.25h6v-5.75h-6v5.75zm-11.5 0h5.5v-5.75H33v5.75zm-11.5 0H27v-5.75h-5.5v5.75zm-12 0h6v-5.75h-6v5.75zM56 9v42c0 .552-.448 1-1 1H5c-.552 0-1-.448-1-1V9c0-.552.448-1 1-1h50c.552 0 1 .448 1 1zM26.916 28.684V20.33c0-.624.668-1.02 1.214-.722l8.356 4.558c.594.324.562 1.188-.052 1.468l-8.356 3.798c-.544.246-1.162-.15-1.162-.748z"></path></g>
    </symbol>
    <symbol id="icon--youtube" viewBox="0 0 60 60">
      ...
      <title>icon--youtube</title>
		<g fill-rule="evenodd">
		<path
			d="M55.207 18.547C55.54 19.85 56 26.98 56 29.7v.6c0 2.72-.46 9.85-.793 11.153-.99 3.87-2.848 5.362-6.27 5.9-1.972.284-11.44.648-18.954.648h.034c-7.514 0-16.982-.363-18.954-.647-3.422-.538-5.28-2.03-6.27-5.9C4.46 40.15 4 33.02 4 30.3v-.6c0-2.72.46-9.85.793-11.153.99-3.87 2.848-5.362 6.27-5.9 1.972-.284 11.44-.646 18.954-.646h-.034c7.514 0 16.982.363 18.954.647 3.422.538 5.28 2.03 6.27 5.9zM24 22.963v14.77l13.813-7.562L24 22.964z"></path></g>
    </symbol>
    <symbol id="icon-imagealign-center" viewBox="0 0 60 60">
      <title>icon-imagealign-center icon</title>
      <title>icon-imagealign-center</title>
		<path
			d="M51 42H9c-.552 0-1 .448-1 1v4c0 .552.448 1 1 1h42c.552 0 1-.448 1-1v-4c0-.552-.448-1-1-1zm-6.833-3c.46 0 .833-1.344.833-3V24c0-1.656-.373-3-.833-3H15.833c-.46 0-.833 1.344-.833 3v12c0 1.656.373 3 .833 3h28.334zM52 13v4c0 .552-.448 1-1 1H9c-.552 0-1-.448-1-1v-4c0-.552.448-1 1-1h42c.552 0 1 .448 1 1z"
			fill-rule="nonzero"></path>
    </symbol>
    <symbol id="icon-imagealign-left" viewBox="0 0 60 60">
      <title>icon-imagealign-left icon</title>
      <title>icon-imagealign-left</title>
		<path
			d="M51 42H9c-.552 0-1 .448-1 1v4c0 .552.448 1 1 1h42c.552 0 1-.448 1-1v-4c0-.552-.448-1-1-1zm-13.833-3c.46 0 .833-1.344.833-3V24c0-1.656-.373-3-.833-3H8.833C8.373 21 8 22.344 8 24v12c0 1.656.373 3 .833 3h28.334zM52 13v4c0 .552-.448 1-1 1H9c-.552 0-1-.448-1-1v-4c0-.552.448-1 1-1h42c.552 0 1 .448 1 1z"
			fill-rule="nonzero"></path>
    </symbol>
    <symbol id="icon-imagealign-right" viewBox="0 0 60 60">
      <title>icon-imagealign-right icon</title>
      <title>icon-imagealign-right</title>
		<path
			d="M51 42H9c-.552 0-1 .448-1 1v4c0 .552.448 1 1 1h42c.552 0 1-.448 1-1v-4c0-.552-.448-1-1-1zm.167-3c.46 0 .833-1.344.833-3V24c0-1.656-.373-3-.833-3H22.833c-.46 0-.833 1.344-.833 3v12c0 1.656.373 3 .833 3h28.334zM52 13v4c0 .552-.448 1-1 1H9c-.552 0-1-.448-1-1v-4c0-.552.448-1 1-1h42c.552 0 1 .448 1 1z"
			fill-rule="nonzero"></path>
    </symbol>
    <symbol id="info" viewBox="0 0 16 16">
      ...
      <title>Combined Shape Copy</title>
		<path
			d="M8 14.47c-3.565 0-6.467-2.902-6.467-6.47 0-3.567 2.902-6.468 6.467-6.468 3.567 0 6.467 2.9 6.467 6.468s-2.9 6.47-6.467 6.47M8 0C3.583 0 0 3.583 0 8c0 4.42 3.583 8 8 8s8-3.58 8-8c0-4.417-3.583-8-8-8m0 4.377c-.48 0-.867.388-.867.867 0 .48.388.867.867.867.48 0 .867-.387.867-.866 0-.48-.388-.867-.867-.867m.556 2.546H7.444c-.112 0-.203.104-.203.23v4.24c0 .127.092.23.204.23h1.112c.112 0 .203-.103.203-.23v-4.24c0-.126-.092-.23-.204-.23"
			fill-rule="evenodd"></path>
    </symbol>
    ...
    <symbol id="kickstarter" viewBox="0 0 590 726">
      ...
      <title>Artboard Copy 5</title>
		<path
			d="M0 612.563V113.438c0-31.196 11.048-57.9 33.145-80.116C55.242 11.107 82.005 0 113.438 0c30.96 0 57.604 11.166 79.937 33.5 22.334 22.333 33.5 48.978 33.5 79.938v121.945L364.772 52.11c18.434-24.814 43.012-39.526 73.735-44.134 30.723-4.608 58.727 2.54 84.014 21.447 24.816 18.434 39.527 43.01 44.136 73.734 4.608 30.723-2.54 58.846-21.447 84.37l-136.835 160.23 156.33 177.246c19.616 24.342 27.77 52.287 24.46 83.837-3.308 31.55-17.133 57.133-41.475 76.748-24.105 19.143-51.342 27.355-81.71 24.637-30.368-2.718-55.714-15.42-76.04-38.108l-163.065-198.16v138.606c0 31.43-11.107 58.195-33.322 80.292C171.338 714.952 144.633 726 113.438 726c-31.67 0-58.492-10.99-80.47-32.968C10.988 671.054 0 644.232 0 612.562z"
			fill-rule="evenodd"></path>
    </symbol>
    ...
    <symbol id="lightbulb" viewBox="0 0 36 52">
      ...
      <title>icon--lightbulb</title>
		<g fill-rule="evenodd">
		<path
			d="M18 52c-3.198 0-5.958-1.876-7.238-4.586-.308-.656.198-1.412.924-1.412L24.314 46c.726 0 1.232.756.924 1.412C23.958 50.124 21.198 52 18 52zm18-34c0 3.406-.962 6.58-2.606 9.296h.018c-.162.26-.312.492-.464.732l-.028.044C29.286 33.746 28 33.642 28 39.786V41c0 .552-.446 1-1 1H9c-.552 0-1-.448-1-1v-1.214c0-6.144-1.284-6.04-4.92-11.714-.01-.014-.018-.03-.026-.044-.154-.24-.304-.472-.466-.732h.02C.964 24.58 0 21.406 0 18 0 8.058 8.06 0 18 0c9.942 0 18 8.058 18 18zm-7.312 6.448C29.874 22.49 30.5 20.258 30.5 18c0-6.892-5.606-12.5-12.5-12.5-6.892 0-12.5 5.608-12.5 12.5 0 2.258.628 4.49 1.812 6.448l.36.594.004.004.048.076c.778 1.218 1.444 2.148 2.03 2.97 1.91 2.67 3.156 4.608 3.582 8.408h9.328c.426-3.8 1.672-5.738 3.582-8.408.586-.82 1.25-1.75 2.028-2.964l.038-.06.024-.036.352-.584z"></path>
		<path d="M-12-4h60v60h-60z"></path></g>
    </symbol>
    <symbol id="link" viewBox="0 0 16 16">
      <title>link icon</title>
      <title>Combined Shape Copy 8</title>
		<path
			d="M8.43 7.57l-.022.02c.387.387.512.915.435 1.418-.052.335-.177.66-.435.915l-3.32 3.318c-.64.644-1.687.644-2.33 0-.642-.64-.642-1.688 0-2.33l1.426-1.426c-.42-.857-.58-1.798-.493-2.728L1.15 9.3c-1.53 1.53-1.53 4.02 0 5.552 1.532 1.53 4.02 1.53 5.552 0l3.32-3.32c.234-.232.42-.493.582-.765.822-1.378.724-3.14-.288-4.427-.096-.122-.183-.247-.295-.36L8.43 7.57zm-.86.86l.02-.02c-.385-.386-.51-.916-.433-1.418.052-.334.177-.658.434-.915l3.32-3.32c.642-.64 1.688-.64 2.332 0 .642.644.642 1.69 0 2.333l-1.426 1.427c.418.857.58 1.798.493 2.728L14.85 6.7c1.53-1.53 1.53-4.02 0-5.55C13.32-.384 10.83-.384 9.3 1.15L5.98 4.467c-.234.233-.42.493-.582.765-.823 1.38-.724 3.142.288 4.427.096.12.183.248.295.36l1.59-1.59z"
			fill-rule="evenodd"></path>
    </symbol>
    <symbol id="loading-spin" viewBox="0 0 32 32">
      <title>loading-spin icon</title>
      <path opacity=".25"
			d="M16 0a16 16 0 0 0 0 32 16 16 0 0 0 0-32m0 4a12 12 0 0 1 0 24 12 12 0 0 1 0-24"></path>
		<path d="M16 0a16 16 0 0 1 16 16h-4A12 12 0 0 0 16 4z"
			transform="rotate(75.7886 16 16)">
		<animateTransform attributeName="transform" type="rotate"
			from="0 16 16" to="360 16 16" dur="0.8s" repeatCount="indefinite"></animateTransform></path>
    </symbol>
    <symbol id="lock" viewBox="0 0 14 16">
      <title>lock icon</title>
      <title>Combined Shape Copy 4</title>
		<path
			d="M3.473 6.927c.07 0 .128-.056.128-.127h.002V4.843c0-1.61 1.308-2.92 2.92-2.92 1.61 0 2.92 1.31 2.92 2.92V6.8c0 .07.056.127.126.127h1.664c.07 0 .128-.056.128-.127h.004V4.843C11.364 2.173 9.192 0 6.52 0 3.85 0 1.68 2.173 1.68 4.843V6.8c0 .07.058.127.128.127h1.667zm9.15.728H.42c-.233 0-.42.186-.42.417v7.51c0 .23.187.418.42.418h12.204c.232 0 .417-.188.417-.42V8.073c0-.23-.184-.417-.416-.417z"
			fill-rule="evenodd"></path>
    </symbol>
    ...
    <symbol id="menu" viewBox="0 0 17 12">
      ...
      <title>Group</title>
		<defs>
		<path id="a" d="M8.03 12H0v-2h16.06v2H8.03z"></path></defs>
		<g fill-rule="evenodd">
		<path
			d="M15.783 0H.276C.124 0 0 .124 0 .276v1.448C0 1.876.124 2 .276 2h15.507c.153 0 .276-.124.276-.276V.276c0-.152-.124-.276-.277-.276M.276 7H12.16c.154 0 .277-.124.277-.276V5.276c0-.152-.123-.276-.276-.276H.277C.124 5 0 5.124 0 5.276v1.448C0 6.876.124 7 .276 7"></path>
		<mask id="b">
		<use xlink:href="#a"></use></mask>
		<path
			d="M15.783 10H.276c-.152 0-.276.124-.276.276v1.448c0 .152.124.276.276.276h15.507c.153 0 .276-.124.276-.276v-1.448c0-.152-.124-.276-.277-.276"
			mask="url(#b)"></path></g>
    </symbol>
    <symbol id="message" viewBox="0 0 20 16">
      ...
      <title>Fill 1 Copy 12</title>
		<path
			d="M17.526 0h-16C.684 0 0 .684 0 1.526v10.16c0 .843.684 1.526 1.526 1.526H3.45c-.103.87-.465 1.824-1.69 2.3l-.083.03v.02c-.09.033-.16.103-.16.203 0 .12.094.213.212.225V16H1.75l.004-.002c2.21-.006 4.674-.95 5.436-2.786h10.336c.84 0 1.525-.683 1.525-1.526V1.526C19.05.684 18.368 0 17.527 0"
			fill-rule="evenodd"></path>
    </symbol>
    <symbol id="mobile" viewBox="0 0 10 16">
      ...
      <title>Page 1 Copy 2</title>
		<path
			d="M7.816 12.744c0 .067-.053.12-.12.12H1.663c-.068 0-.12-.053-.12-.12V1.664c0-.065.052-.12.12-.12h6.03c.07 0 .122.055.122.12v11.08zm-2.173 2c0 .115-.09.205-.204.205H3.916c-.113 0-.204-.09-.204-.205v-.702c0-.112.09-.204.204-.204H5.44c.112 0 .203.09.203.203v.702zM8.595 0H.76C.34 0 0 .34 0 .76v14.48c0 .42.34.76.76.76h7.835c.42 0 .76-.34.76-.76V.76c0-.42-.34-.76-.76-.76z"
			fill-rule="evenodd"></path>
    </symbol>
    ...
    <symbol id="pencil" viewBox="0 0 16 16">
      ...
      <title>Combined Shape Copy 3</title>
		<path
			d="M15.787 3.22L12.78.216c-.286-.287-.75-.287-1.035 0L10.09 1.868l4.042 4.045 1.655-1.656c.286-.287.286-.75 0-1.036M3.523 14.744H2.495v-1.235H1.26v-1.03l1.137-1.14 2.265 2.266-1.14 1.14zM9.42 2.54L3.61 8.345 0 11.956v3.732c.007.213.105.312.307.312h3.74l3.61-3.61h-.002l5.807-5.808L9.42 2.54z"
			fill-rule="evenodd"></path>
    </symbol>
    ...
    <symbol id="play" viewBox="0 0 12 12">
      ...
      <title>play copy</title>
		<path
			d="M0 .252C0 .155.037.084.11.042.19-.01.274-.014.364.03L11.86 5.777c.093.043.14.118.14.223 0 .106-.047.18-.14.223L.362 11.97c-.047.02-.084.03-.11.03-.056 0-.103-.014-.142-.04-.073-.044-.11-.114-.11-.212V.252z"
			fill-rule="evenodd"></path>
    </symbol>
    <symbol id="plus-human" viewBox="0 0 56 46">
      ...
      <title>icon--plus-human</title>
		<path
			d="M48 12c0 6.626-5.374 12-12 12s-12-5.374-12-12S29.374 0 36 0s12 5.374 12 12zM17 46c-.552 0-1-.448-1-1v-6.83c0-.286.118-.56.326-.752C21.29 32.858 28.258 30 36 30c7.742 0 14.708 2.856 19.674 7.416.208.194.326.468.326.754V45c0 .552-.448 1-1 1H17zm2-26c.552 0 1 .448 1 1v2c0 .552-.448 1-1 1h-7v7c0 .552-.448 1-1 1H9c-.552 0-1-.448-1-1v-7H1c-.552 0-1-.448-1-1v-2c0-.552.448-1 1-1h7v-7c0-.552.448-1 1-1h2c.552 0 1 .448 1 1v7h7z"
			fill-rule="evenodd"></path>
    </symbol>
    <symbol id="plus" viewBox="0 0 16 16">
      ...
      <title>Fill 1 Copy 7</title>
		<path
			d="M15.65 6.735H9.266V.35c0-.194-.157-.35-.35-.35h-1.83c-.194 0-.35.156-.35.35v6.385H.35c-.194 0-.35.157-.35.35v1.83c0 .193.156.35.35.35h6.385v6.386c0 .194.156.35.35.35h1.83c.193 0 .35-.156.35-.35V9.266h6.386c.193 0 .35-.157.35-.35v-1.83c0-.193-.157-.35-.35-.35"
			fill-rule="evenodd"></path>
    </symbol>
    ...
    <symbol id="search" viewBox="0 0 16 16">
      ...
      <title>Fill 1 Copy 11</title>
		<path
			d="M6.678 11.222c-2.507 0-4.544-2.04-4.544-4.545 0-2.506 2.037-4.545 4.544-4.545 2.506 0 4.545 2.04 4.545 4.545 0 2.506-2.04 4.545-4.545 4.545m9.26 3.208l-3.852-3.852c.795-1.1 1.27-2.445 1.27-3.9C13.356 2.994 10.36 0 6.678 0 2.995 0 0 2.995 0 6.677c0 3.682 2.995 6.677 6.678 6.677 1.457 0 2.802-.473 3.9-1.268l3.85 3.85c.037.037.082.064.138.064.056 0 .104-.027.142-.065l1.236-1.238c.035-.033.06-.077.06-.128 0-.057-.025-.105-.065-.14"
			fill-rule="evenodd"></path>
    </symbol>
    <symbol id="shapeshift" viewBox="0 0 144 144">
      <title>shapeshift icon</title>
      <path
			d="M 112.6 73.1495 C 112.6 90.0231 118.986 103.358 108.612 115.183 C 103.718 120.792 97.3173 124.882 90.1774 126.97 C 83.0386 129.057 75.4571 129.055 68.3402 126.976 C 53.4308 122.824 58.269 104.625 48.3105 94.6287 C 37.4945 83.8113 13.5968 86.9557 13.9401 70.516 C 14.2834 54.0764 35.9913 39.113 49.418 34.4784 C 61.7044 30.2271 68.0036 16.8309 83.3298 13.3524 C 98.6561 9.87387 119.535 14.8009 124.203 28.6918 C 126.841 36.6147 123.942 43.7193 120.384 50.8533 C 116.825 57.9874 112.601 65.1387 112.6 73.1495 Z">
		<animate repeatCount="indefinite" attributeName="d" dur="3s"
			values="M 130.28 72 C 130.28 85.48 125.603 98.552 117.051 108.973 C 108.499 119.393 96.592 126.53 83.37 129.16 C 70.149 131.79 56.416 129.753 44.527 123.399 C 32.639 117.044 23.315 106.758 18.156 94.303 C 12.998 81.849 12.316 67.983 16.229 55.083 C 20.143 42.183 28.413 31.032 39.621 23.542 C 50.83 16.053 64.297 12.68 77.712 14.001 C 91.128 15.322 103.678 21.258 113.21 30.79 C 118.63 36.196 122.928 42.62 125.857 49.692 C 128.787 56.764 130.29 64.345 130.28 72 Z; M 110.9 73.26 C 110.9 90.46 118.35 103.82 107.8 115.78 C 103.258 120.926 97.387 124.724 90.832 126.759 C 84.278 128.794 77.288 128.988 70.63 127.32 C 55.43 123.38 61.63 104.42 51.21 94.66 C 39.85 84 13.72 88.78 13.72 72 C 13.72 55.22 36.72 39.89 50.36 35.53 C 62.75 31.59 68.36 17.23 83.87 13.29 C 99.38 9.35 121.06 14.18 125.26 28.49 C 127.63 36.655 124.04 43.825 119.858 50.965 C 115.675 58.105 110.9 65.215 110.9 73.26 Z; M 130.28 72 C 130.28 85.48 125.603 98.552 117.051 108.973 C 108.499 119.393 96.592 126.53 83.37 129.16 C 70.149 131.79 56.416 129.753 44.527 123.399 C 32.639 117.044 23.315 106.758 18.156 94.303 C 12.998 81.849 12.316 67.983 16.229 55.083 C 20.143 42.183 28.413 31.032 39.621 23.542 C 50.83 16.053 64.297 12.68 77.712 14.001 C 91.128 15.322 103.678 21.258 113.21 30.79 C 118.63 36.196 122.928 42.62 125.857 49.692 C 128.787 56.764 130.29 64.345 130.28 72 Z"></animate></path>
    </symbol>
    <symbol id="share" viewBox="0 0 19 16">
      <title>share icon</title>
      <title>Fill 1 Copy</title>
		<path
			d="M10.017 4.092v-.266c-.004-.713.012-2.726.02-3.57.004-.222.267-.338.434-.19 1.302 1.16 5.26 4.683 7.244 6.443.278.246.56.49.835.74.245.222.245.302-.005.525-1.414 1.26-6.57 5.91-8.108 7.3-.167.15-.434.03-.433-.195l.008-3.873c-.342 0-.68-.02-1.013.004-1.836.135-3.748.643-5.268 1.642-1.3.834-2.442 2.235-3.142 3.212-.195.272-.626.106-.588-.227.226-1.98 1.157-5.912 3.608-8.42 2.67-2.73 6.333-3.117 6.407-3.125"
			fill-rule="evenodd"></path>
    </symbol>
    <symbol id="slash" viewBox="0 0 12 16">
      <title>slash icon</title>
      <path d="M11 1L1 15" stroke="#A9A9A9"></path>
    </symbol>
    <symbol id="solid-arrow" viewBox="0 0 859 537">
      <title>solid-arrow icon</title>
      <title>solid-arrow</title>
		<path
			d="M17.89 0h822.93c7.55 0 12.862 3.355 15.938 10.066 3.076 6.99 2.516 13.282-1.678 18.875L443.196 529.746c-3.635 4.753-8.25 7.13-13.84 7.13-6.433 0-11.046-2.377-13.842-7.13L3.63 28.94C-.565 23.35-1.124 17.058 1.952 10.067 5.028 3.356 10.342 0 17.89 0z"
			fill-rule="evenodd"></path>
    </symbol>
    ...
    <symbol id="sound-lo" viewBox="0 0 16 15">
      ...
      <title>Combined Shape</title>
		<path
			d="M13.355 1.686L12.05 2.992c2.31 2.31 2.31 6.07 0 8.382l1.305 1.305c3.03-3.032 3.03-7.962 0-10.994zM8.97.036c-.147-.067-.28-.04-.396.077L4.31 3.958H.362c-.1 0-.187.034-.257.105-.07.07-.105.155-.105.256v5.738c0 .1.034.186.105.256.07.07.156.106.257.106H4.31l4.264 3.844c.066.067.15.1.252.1.044 0 .092-.007.143-.024.145-.056.218-.165.218-.33V.366c0-.163-.073-.272-.22-.328z"
			fill-rule="evenodd"></path>
    </symbol>
    <symbol id="sound-mute" viewBox="0 0 23 16">
      ...
      <title>Combined Shape</title>
		<path
			d="M9.99.04c-.163-.074-.31-.046-.44.086L4.8 4.408H.404c-.112 0-.208.04-.286.117-.08.078-.117.173-.117.285v6.392c0 .113.038.207.117.285.078.078.174.118.286.118H4.8l4.75 4.283c.073.074.168.112.28.112.05 0 .103-.01.16-.03.16-.06.243-.182.243-.365V.407c0-.182-.082-.303-.244-.366zm12.75 4.744l-1.357-1.357-3.158 3.158-3.16-3.158-1.357 1.357 3.158 3.158-3.158 3.16 1.357 1.357 3.16-3.16 3.158 3.16 1.357-1.36-3.158-3.158 3.158-3.158z"
			fill-rule="evenodd"></path>
    </symbol>
    <symbol id="star" viewBox="0 0 17 16">
      ...
      <title>Fill 1 Copy 2</title>
		<path
			d="M8.398 12.888L3.506 15.96c-.197.124-.445-.057-.388-.284l1.41-5.6L.092 6.37c-.18-.148-.084-.44.148-.455l5.765-.392L8.158.163c.087-.217.394-.217.48 0l2.154 5.36 5.764.392c.232.016.327.307.148.456l-4.434 3.705 1.41 5.6c.056.228-.192.41-.39.285L8.4 12.888z"
			fill-rule="evenodd"></path>
    </symbol>
    ...
    <symbol id="tumblr" viewBox="0 0 11 16">
      ...
      <title>tumblr copy</title>
		<path
			d="M10.336 15.133c-.037.026-.09.057-.16.094-.07.036-.224.105-.46.207-.238.1-.488.19-.75.265-.264.075-.604.144-1.02.206-.417.063-.842.094-1.274.094-1.485 0-2.578-.33-3.28-.992-.705-.662-1.056-1.664-1.056-3.008V7H0V4.664c.427-.14.8-.292 1.12-.453.32-.16.633-.365.935-.612.302-.248.556-.532.76-.852.207-.32.384-.71.533-1.172.148-.46.256-.985.324-1.574H6v4h3.672v3H6v4c0 .443.026.8.078 1.074.052.274.15.51.297.71.146.202.35.344.61.427.26.084.598.126 1.015.126.297 0 .64-.056 1.027-.168.388-.112.705-.225.95-.34l.36-.164v2.47z"
			fill-rule="evenodd"></path>
    </symbol>
    ...
    <symbol id="warning" viewBox="0 0 16 16">
      ...
      <title>Combined Shape Copy 10</title>
		<path
			d="M8 14.47c-3.567 0-6.468-2.902-6.468-6.47 0-3.567 2.9-6.468 6.468-6.468 3.565 0 6.467 2.9 6.467 6.468S11.565 14.47 8 14.47M8 0C3.58 0 0 3.583 0 8c0 4.42 3.58 8 8 8 4.417 0 8-3.58 8-8 0-4.417-3.583-8-8-8m0 10.344c-.516 0-.933.418-.933.934 0 .514.417.933.933.933s.932-.418.932-.932c0-.516-.416-.934-.932-.934m-.413-.874h.83c.094 0 .118-.065.13-.15l.212-1.89v-3.4c-.002-.045-.038-.083-.085-.083v-.002h-1.35v.002c-.046 0-.084.038-.084.083v3.4l.214 1.88c.01.09.035.16.133.16"
			fill-rule="evenodd"></path>
    </symbol>
    <symbol id="write" viewBox="0 0 712 711">
      ...
      <title>Artboard Copy 11</title>
		<path
			d="M75.003 504.435c.694-1.852 1.736-3.472 3.124-4.86L444.39 133.313 577.7 266.625 211.44 632.887c-1.39 1.39-3.01 2.43-4.86 3.125L20.496 710.306c-1.62.463-3.47.694-5.554.694-3.703 0-7.29-1.39-10.763-4.166C.246 702.9-.91 697.46.71 690.517l74.293-186.082zm413.824-415.56l75.683-75.683C573.305 4.397 583.777 0 595.928 0c12.15 0 22.855 4.397 32.113 13.192l69.782 69.78c8.795 9.26 13.192 19.963 13.192 32.114 0 12.15-4.397 22.624-13.192 31.42l-75.683 75.68-133.313-133.31z"
			fill-rule="evenodd"></path>
    </symbol>
    <symbol id="x" viewBox="0 0 16 16">
      ...
      <title>Fill 1 Copy 4</title>
		<path
			d="M9.805 8l6.092-6.092c.138-.138.138-.36 0-.5L14.59.103c-.136-.136-.36-.136-.497 0L8 6.196 1.908.102c-.136-.136-.36-.136-.497 0L.103 1.41c-.137.137-.137.36 0 .498L6.197 8 .103 14.092c-.137.138-.137.36 0 .5l1.307 1.306c.138.136.36.136.497 0L8 9.804l6.093 6.094c.138.136.36.136.498 0l1.307-1.307c.138-.137.138-.36 0-.498L9.805 8z"
			fill-rule="evenodd"></path>
    </symbol>
    <symbol id="youtube" viewBox="0 0 23 16">
      ...
      <title>Combined Shape</title>
		<path
			d="M22.226 2.91C21.796 1.19 20.99.527 19.504.287 18.648.162 14.54 0 11.278 0h.014c-3.26 0-7.37.162-8.226.287C1.58.527.774 1.19.344 2.91.2 3.49 0 6.658 0 7.868v.264c0 1.21.2 4.38.344 4.958.43 1.72 1.237 2.383 2.722 2.623.856.125 4.965.287 8.226.287h-.014c3.26 0 7.37-.162 8.226-.287 1.485-.24 2.292-.903 2.722-2.623.145-.58.344-3.748.344-4.958v-.264c0-1.21-.2-4.38-.344-4.958zM8.94 4.758l5.997 3.13-5.996 3.28V4.76z"
			fill-rule="evenodd"></path>
    </symbol></svg>



<!--  -->
	<iframe scrolling="no" frameborder="0" allowtransparency="true"
		src="https://platform.twitter.com/widgets/widget_iframe.2d991e3dfc9abb2549972ce8b64c5d85.html?origin=https%3A%2F%2Fwww.kickstarter.com"
		title="Twitter settings iframe" style="display: none;"></iframe>
	<iframe name="stripeXDM_default24268_provider"
		id="stripeXDM_default24268_provider" aria-hidden="true"
		src="https://js.stripe.com/v2/channel.html?stripe_xdm_e=https%3A%2F%2Fwww.kickstarter.com&amp;stripe_xdm_c=default24268&amp;stripe_xdm_p=1#__stripe_transport__"
	...
	<iframe frameborder="0" allowtransparency="true" scrolling="no"
		...
		src="https://js.stripe.com/v2/m/outer.html#url=https%3A%2F%2Fwww.kickstarter.com%2Fstart%3Fref%3Dlearn_top&amp;title=Create%20your%20project%20%E2%80%94%20Kickstarter&amp;referrer=https%3A%2F%2Fwww.kickstarter.com%2Flearn%3Fref%3Dnav&amp;muid=a47f76d6-3aef-4c4a-b64c-549b284630ed&amp;sid=660b3d42-25f6-47f5-8811-583e95a7e16f&amp;preview=false"
	...
	<script type="text/javascript"
		src="https://zncv1onfo8kuflf0n-kickstarter.siteintercept.qualtrics.com/WRSiteInterceptEngine/?Q_ZID=ZN_cV1oNFo8KUFlf0N&amp;t=1572665743539"></script>
	<script
		src="https://siteintercept.qualtrics.com/dxjsmodule/CoreModule.js?Q_CLIENTVERSION=1.13.1&amp;Q_CLIENTTYPE=web"
		defer=""></script>
</body>
</body>
